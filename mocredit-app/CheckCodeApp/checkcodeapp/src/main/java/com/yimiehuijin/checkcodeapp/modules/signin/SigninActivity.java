...
import com.yimiehuijin.checkcodeapp.modules.checkcode.CheckcodeActivity;
import com.yimiehuijin.codeandbonuslibrary.App;
import com.yimiehuijin.checkcodeapp.service.WangposService;
        ...
        if(App.getInstance().deviceInfo == null){
            ...
            signListener = new SigninUtil.SigninListener() {
                ...
                public void onSigninSuccess() {
                    ...
                    startService(i);
                    i = new Intent(SigninActivity.this, CheckcodeActivity.class);
                    startActivity(i);
                }
