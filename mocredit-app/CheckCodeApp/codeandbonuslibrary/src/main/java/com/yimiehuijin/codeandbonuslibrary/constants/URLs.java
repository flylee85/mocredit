package com.yimiehuijin.codeandbonuslibrary.constants;
...
public class URLs {
	 ...
	 * IP address
	 */
	 private static String IP = "117.121.20.137";
...
//	private static String PORT = ":12345";
	...
	public static void setIP(String iP) {
		IP = iP;
		PreferenceUtil.put(PreferenceUtil.DEFAULT_IP,
				PreferenceUtil.DEFAULT_IP, IP);
		generateURLs();
	}
	...
	public static void setPORT(String pORT) {
		PORT = pORT;
		PreferenceUtil.put(PreferenceUtil.DEFAULT_IP,
				PreferenceUtil.DEFAULT_PORT, PORT);
		generateURLs();
	}
