package cn.mocredit.gateway.wangpos.monitor;
...
public class ControllerMonitor {
	...
	@Before("execution(public * cn.mocredit.gateway.wangpos.controller.*.*(..))")
	...
	@AfterReturning(value = "execution(public * cn.mocredit.gateway.wangpos.controller.*.*(..))", returning = "ret")
	...
	@AfterThrowing(value = "execution(* cn.mocredit.gateway.wangpos.controller.*.*(..))", throwing = "ex")
