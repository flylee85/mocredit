...
public interface BaseDao<T extends Serializable> {
	...
	public List<T> findByEgList(T eg,
			int firstResult, int maxResult, String... exclude);
	public Pagination<T> findByEg(T exampleInstance, boolean anyWhere,
			Condition[] conds, int pageNo, int pageSize, String... exclude);
	public Pagination<T> findByEg(T exampleInstance, Condition[] conds, int pageNo, int pageSize, String... exclude);
	public Pagination<T> findByEg(T exampleInstance, int pageNo, int pageSize, String... exclude);
