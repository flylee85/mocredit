...
import cn.mocredit.posp.bc.binding.UP_LoadSchema;
 ...
 *
 */
public class PointsEncodeDetail {
	private static Logger logger = Logger.getLogger(PointsEncodeDetail.class);
...
//					
	...
	public boolean isVerifyMAC(MessageObject request) throws FormatException {
		try {
			...
			if (msgType == null) {
				return false;
			} else if (msgType.startsWith("12") || msgType.startsWith("06") || msgType.startsWith("08") || msgType.startsWith("05")) {
				return false;
