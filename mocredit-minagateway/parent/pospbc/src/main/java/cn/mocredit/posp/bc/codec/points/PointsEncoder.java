...
public class PointsEncoder {
	...
	public PointsEncoder(SD_TERM_KEY_Dao sD_TERM_KEY_dao) {
...
//		finder.setParam("TERM_ID", request.getField41_Card_Acceptor_Terminal_ID());
//		finder.setParam("MERCH_ID", request.getField42_Card_Acceptor_ID());
...
//				HexBinary.decode("131383F2573B1CBA9B9E6D54EF75DFD9".substring(16,32)), bodySource);
		String resultMac = MacECBUtils.clacMsyhMac(HexBinary.decode(sdTermKey.getTMK_TAK().substring(0,16)),
				HexBinary.decode(sdTermKey.getTMK_TAK().substring(16,32)), bodySource);
