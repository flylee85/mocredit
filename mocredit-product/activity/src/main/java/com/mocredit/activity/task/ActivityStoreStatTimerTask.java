 ...
 */
public class ActivityStoreStatTimerTask {
    public final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory
            .getLogger("ActivityStoreStatTimerTask");
    @Autowired
                            ...
                            if (null != url) {
                                ...
                                if (StringUtils.isNotBlank(returnJson)) {
                                    ...
                                    if (ajaxResponseData.getData() != null) {
                                        ...
                                        LOGGER.info("### ActivityStoreStatTimerTask activityId={} storeId={} ###", actStoreStat.getActivityId(), activityStoreStat.getStoreId());
                                    }
                                }
                            }
                        }
