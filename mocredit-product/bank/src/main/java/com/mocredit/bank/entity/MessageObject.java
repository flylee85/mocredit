...
public class MessageObject {
	...
	public String toString() {
		return "POSRequest [messtype=" + messtype + ", tranCode=" + tranCode + ", field02_Primary_Account_Number="
				+ field02_Primary_Account_Number + ", field03_Processing_Code=" + field03_Processing_Code
				+ ", field04_Amount_Of_Transactions=" + field04_Amount_Of_Transactions + ", field05_Mobile_Number="
				+ field05_Mobile_Number + ", field11_System_Trace_Audit_Number=" + field11_System_Trace_Audit_Number
				+ ", field12_Time_Of_Local_Transaction=" + field12_Time_Of_Local_Transaction
				+ ", field13_Date_Of_Local_Transaction=" + field13_Date_Of_Local_Transaction
				+ ", field14_Date_Of_Expired=" + field14_Date_Of_Expired + ", field15_Date_Of_Settlement="
				+ field15_Date_Of_Settlement + ", field22_Point_Of_Service_Entry_Mode="
				+ field22_Point_Of_Service_Entry_Mode + ", field23_Card_SN=" + field23_Card_SN
				+ ", field25_Point_Of_Service_Condition_Mode=" + field25_Point_Of_Service_Condition_Mode
				+ ", field26_POS_PIN_Capture_Code=" + field26_POS_PIN_Capture_Code + ", field32_Acquiring_Institution="
				+ field32_Acquiring_Institution + ", field35_Track2_Data=" + field35_Track2_Data
				+ ", field36_Track3_Data=" + field36_Track3_Data + ", field37_Retrieval_Reference_Number="
				+ field37_Retrieval_Reference_Number + ", field38_Authorization_Identification_Response="
				+ field38_Authorization_Identification_Response + ", field39_Response_Code=" + field39_Response_Code
				+ ", field41_Card_Acceptor_Terminal_ID=" + field41_Card_Acceptor_Terminal_ID
				+ ", field42_Card_Acceptor_ID=" + field42_Card_Acceptor_ID + ", field44_Additional_Response_Data="
				+ field44_Additional_Response_Data + ", field48_Additional_Data=" + field48_Additional_Data
				+ ", field49_Currency_Code_Of_Transaction=" + field49_Currency_Code_Of_Transaction
				+ ", field52_PIN_Data=" + field52_PIN_Data + ", field53_Security_Control_Information="
				+ field53_Security_Control_Information + ", field54_Balance_Amount=" + field54_Balance_Amount
				+ ", field55_IC_DATA=" + field55_IC_DATA + ", field58_PBOC_ELECTRONIC_DATA="
				+ field58_PBOC_ELECTRONIC_DATA + ", field60_Reserved_Private=" + field60_Reserved_Private
				+ ", field61_Original_Message=" + field61_Original_Message + ", field62_Reserved_Private="
				+ field62_Reserved_Private + ", field63_Reserved_Private=" + field63_Reserved_Private + ", field64_MAC="
				+ field64_MAC + "]";
	}
	...
	public void setField02_Primary_Account_Number(String field02_Primary_Account_Number) {
	...
	public void setField04_Amount_Of_Transactions(String field04_Amount_Of_Transactions) {
	...
	public void setField11_System_Trace_Audit_Number(String field11_System_Trace_Audit_Number) {
	...
	public void setField12_Time_Of_Local_Transaction(String field12_Time_Of_Local_Transaction) {
	...
	public void setField13_Date_Of_Local_Transaction(String field13_Date_Of_Local_Transaction) {
	...
	public void setField22_Point_Of_Service_Entry_Mode(String field22_Point_Of_Service_Entry_Mode) {
	...
	public void setField25_Point_Of_Service_Condition_Mode(String field25_Point_Of_Service_Condition_Mode) {
	...
	public void setField32_Acquiring_Institution(String field32_Acquiring_Institution) {
	...
	public void setField37_Retrieval_Reference_Number(String field37_Retrieval_Reference_Number) {
	...
	public void setField38_Authorization_Identification_Response(String field38_Authorization_Identification_Response) {
	...
	public void setField41_Card_Acceptor_Terminal_ID(String field41_Card_Acceptor_Terminal_ID) {
	...
	public void setField44_Additional_Response_Data(String field44_Additional_Response_Data) {
	...
	public void setField49_Currency_Code_Of_Transaction(String field49_Currency_Code_Of_Transaction) {
	...
	public void setField53_Security_Control_Information(String field53_Security_Control_Information) {
