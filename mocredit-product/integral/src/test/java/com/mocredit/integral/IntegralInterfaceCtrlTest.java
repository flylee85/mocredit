...
public class IntegralInterfaceCtrlTest {
    ...
    public void paymentTest() throws Exception {
        ...
        Response resp = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "payment", jsonStr), Response.class);
        //活动不存在流程
        String jsonStr1 = "{\"bank\":\"citic\",\"device\":\"10010\",\"activityId\":\"100110\",\"orderId\":\"12342\"," +
                "\"shopId\":\"1\",\"shopName\":\"星巴克\",\"storeId\":\"1\",\"storeName\":\"环球中心\",\"cardNum\":\"62140038786912\",\"integral\":\"100\"}";
        Response resp1 = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "payment", jsonStr1), Response.class);
        //该活动不包含该商铺的门店
        ...
        Response resp2 = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "payment", jsonStr2), Response.class);
        String a = "";
    }
    ...
    public void paymentRevoke() throws Exception {
        ...
        Response resp = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "paymentRevoke", jsonStr), Response.class);
        System.out.println();
        //消費失敗及數據庫不存在该订单信息
        String jsonStr1 = "{\"device\":\"-1\",\"orderId\":\"12342\"}";
        Response resp1 = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "paymentRevoke", jsonStr1), Response.class);
        System.out.println();
        //积分订单不存在
        String jsonStr2 = "{\"device\":\"10010\",\"orderId\":\"12333\"}";
        Response resp2 = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "paymentRevoke", jsonStr2), Response.class);
        System.out.println();
    }
    ...
    public void confirmInfoTest() throws Exception {
        ...
        Response resp = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "confirmInfo", jsonStr), Response.class);
        confirmInfoVo.setActivityId(10010);
        confirmInfoVo.setShopId(1);
        String jsonStr1 = JSON.toJSONString(confirmInfoVo);
        Response resp1 = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "confirmInfo", jsonStr1), Response.class);
        System.out.println();
    }
    ...
    public void testPaymentReserval() throws Exception {
        //積分消費撤銷
        String jsonStr = "{\"device\":\"10010\",\"orderId\":\"12342\"}";
        Response resp = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "paymentReserval", jsonStr), Response.class);
        System.out.println();
    }
    /**
     * http请求参数
    ...
    public void paymentRevokeReserval() throws Exception {
        //積分消費撤銷
        String jsonStr = "{\"device\":\"10010\",\"orderId\":\"12342\"}";
        Response resp = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "paymentRevokeReserval", jsonStr), Response.class);
        System.out.println();
    }
    ...
    public void activityImport() throws Exception {
        ...
        //新增活動
        Response resp = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "activityImport", JSON.toJSONString(activityVo)), Response.class);
        Assert.assertTrue(resp.getSuccess());
        //更新活動
        activityVo.setOperCode(2);
        activityVo.setActivityName("麦当劳");
        Response resp2 = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "activityImport", JSON.toJSONString(activityVo)), Response.class);
        ...
        Response resp3 = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "activityImport", JSON.toJSONString(activityVo1)), Response.class);
        Assert.assertTrue(resp3.getSuccess());
        //啟用活动
        activityVo1.setOperCode(4);
        Response resp4 = JSON.parseObject(HttpRequestUtil.doPostJson(BASE_URL + "activityImport", JSON.toJSONString(activityVo1)), Response.class);
