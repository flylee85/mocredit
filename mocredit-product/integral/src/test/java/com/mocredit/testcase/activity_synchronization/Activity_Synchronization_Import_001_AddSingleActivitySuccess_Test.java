 ...
 * 
 * @Description     活动同步_同步新增单个活动
 * 
 * */

public class Activity_Synchronization_Import_001_AddSingleActivitySuccess_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_AddSingleActivitySuccess(String baseUrl)throws Exception {
