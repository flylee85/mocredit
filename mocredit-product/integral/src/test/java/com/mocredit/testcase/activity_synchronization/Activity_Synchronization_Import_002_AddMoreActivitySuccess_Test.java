 ...
 * 
 * @Description     活动同步_同步新增多个活动
 * 
 * */

public class Activity_Synchronization_Import_002_AddMoreActivitySuccess_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_AddMoreActivitySuccess_Test(String baseUrl)throws Exception {
		...
		String maxType_everyweek = PropertyUtil.getProInfo("parmeter", "maxType_everyweek");
		...
		String storeId1 = PropertyUtil.getProInfo("parmeter", "storeId1");
		String shopId1 = PropertyUtil.getProInfo("parmeter", "shopId1");
		String storeId2 = PropertyUtil.getProInfo("parmeter", "storeId2");
		String shopId2 = PropertyUtil.getProInfo("parmeter", "shopId2");
		// 定义一个字符串缓冲区
		...
		// 定义maxType字段
		Buffer.append("\"maxType\"").append(":").append("\"").append(maxType_everyweek).append("\"");
		// 定义maxNumber字段
		...
		// 定义storeId1字段
		Buffer.append("\"storeId\"").append(":").append("\"").append(storeId1).append("\"");
		// 定义shopId1字段
		Buffer.append("\"shopId\"").append(":").append("\"").append(shopId1).append("\"");
		// 定义第一组结束
		Buffer.append("}").append(",");
		// 定义第二组开始
		Buffer.append("{");		
		// 定义storeId2字段
		Buffer.append("\"storeId\"").append(":").append("\"").append(storeId2).append("\"");
		// 定义shopId2字段
		Buffer.append("\"shopId\"").append(":").append("\"").append(shopId2).append("\"");
		// 定义storeList结束
		Buffer.append("}").append("]");
		// 定义缓冲区结束
		Buffer.append("}");
