 ...
 * 
 * @Description     活动同步_活动ID为空
 * 
 * */

public class Activity_Synchronization_Import_006_EmptyActivityId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EmptyActivityId(String baseUrl)throws Exception {
		...
		Buffer.append("{");
		// 定义activityId字段
		Buffer.append("\"activityId\"").append(":").append("\"").append(activityId_empty).append("\"");
		// 定义activityName字段
