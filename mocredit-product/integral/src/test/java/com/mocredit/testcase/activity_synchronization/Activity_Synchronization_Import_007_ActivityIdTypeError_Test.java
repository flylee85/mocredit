 ...
 * 
 * @Description     活动同步_活动ID参数类型错误
 * 
 * */

public class Activity_Synchronization_Import_007_ActivityIdTypeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ActivityIdTypeError(String baseUrl)throws Exception {
		...
		Buffer.append("{");
		// 定义activityId字段
		Buffer.append("\"activityId\"").append(":").append("\"").append(activityId_type).append("\"");
		// 定义activityName字段
