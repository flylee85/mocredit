 ...
 * 
 * @Description     活动同步_活动ID参数过长
 * 
 * */

public class Activity_Synchronization_Import_009_LongerActivityId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_LongerActivityId(String baseUrl)throws Exception {
		...
		Buffer.append("{");
		// 定义activityId字段
		Buffer.append("\"activityId\"").append(":").append("\"").append(activityId_longer).append("\"");
		// 定义activityName字段
