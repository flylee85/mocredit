 ...
 * 
 * @Description     活动同步_活动ID参数为null
 * 
 * */

public class Activity_Synchronization_Import_010_ActivityIdNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ActivityIdNull(String baseUrl)throws Exception {
		...
		Buffer.append("{");
		// 定义activityId字段
		Buffer.append("\"activityId\"").append(":").append("\"").append(activityId_null).append("\"");
		// 定义activityName字段
