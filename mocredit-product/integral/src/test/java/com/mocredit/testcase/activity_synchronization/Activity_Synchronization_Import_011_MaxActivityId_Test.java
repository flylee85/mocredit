 ...
 * 
 * @Description     活动同步_活动ID参数为最大长度30
 * 
 * */

public class Activity_Synchronization_Import_011_MaxActivityId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_MaxActivityId(String baseUrl)throws Exception {
		...
		Buffer.append("{");
		// 定义activityId字段
		Buffer.append("\"activityId\"").append(":").append("\"").append(activityId_max).append("\"");
		// 定义activityName字段
