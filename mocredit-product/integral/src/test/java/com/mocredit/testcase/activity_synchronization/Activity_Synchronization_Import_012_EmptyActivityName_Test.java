 ...
 * 
 * @Description     活动同步_活动名为空
 * 
 * */

public class Activity_Synchronization_Import_012_EmptyActivityName_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EmptyActivityName(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityName_empty = PropertyUtil.getProInfo("parmeter", "activityId_empty");
		...
		// 定义activityName字段
		Buffer.append("\"activityName\"").append(":").append("\"").append(activityName_empty).append("\"");
		// 定义productCode字段
