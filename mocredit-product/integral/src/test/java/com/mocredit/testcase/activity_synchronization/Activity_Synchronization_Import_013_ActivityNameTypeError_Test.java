 ...
 * 
 * @Description     活动同步_活动名参数类型错误
 * 
 * */

public class Activity_Synchronization_Import_013_ActivityNameTypeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ActivityNameTypeError(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityName_type = PropertyUtil.getProInfo("parmeter", "activityName_type");
		...
		// 定义activityName字段
		Buffer.append("\"activityName\"").append(":").append("\"").append(activityName_type).append("\"");
		// 定义productCode字段
