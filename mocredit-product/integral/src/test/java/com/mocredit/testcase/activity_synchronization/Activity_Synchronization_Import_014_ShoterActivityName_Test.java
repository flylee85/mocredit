 ...
 * 
 * @Description     活动同步_活动名参数过短
 * 
 * */

public class Activity_Synchronization_Import_014_ShoterActivityName_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ShoterActivityName(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityName_shorter = PropertyUtil.getProInfo("parmeter", "activityName_shorter");
		...
		// 定义activityName字段
		Buffer.append("\"activityName\"").append(":").append("\"").append(activityName_shorter).append("\"");
		// 定义productCode字段
