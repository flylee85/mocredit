 ...
 * 
 * @Description     活动同步_活动名参数过长
 * 
 * */

public class Activity_Synchronization_Import_015_LongerActivityName_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_LongerActivityName(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityName_longer = PropertyUtil.getProInfo("parmeter", "activityName_longer");
		...
		// 定义activityName字段
		Buffer.append("\"activityName\"").append(":").append("\"").append(activityName_longer).append("\"");
		// 定义productCode字段
