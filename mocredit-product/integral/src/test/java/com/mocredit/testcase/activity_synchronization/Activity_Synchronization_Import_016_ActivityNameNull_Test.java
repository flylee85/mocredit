 ...
 * 
 * @Description     活动同步_活动名参数为null
 * 
 * */

public class Activity_Synchronization_Import_016_ActivityNameNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ActivityNameNull(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityName_null = PropertyUtil.getProInfo("parmeter", "activityName_null");
		...
		// 定义activityName字段
		Buffer.append("\"activityName\"").append(":").append("\"").append(activityName_null).append("\"");
		// 定义productCode字段
