 ...
 * 
 * @Description     活动同步_活动名参数为最大长度30
 * 
 * */

public class Activity_Synchronization_Import_017_MaxActivityName_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_MaxActivityName(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityName_max = PropertyUtil.getProInfo("parmeter", "activityName_max");
		...
		// 定义activityName字段
		Buffer.append("\"activityName\"").append(":").append("\"").append(activityName_max).append("\"");
		// 定义productCode字段
