 ...
 * 
 * @Description     活动同步_银行内部代码为空
 * 
 * */

public class Activity_Synchronization_Import_018_EmptyProductCode_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EmptyProductCode(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityName = PropertyUtil.getProInfo("parmeter", "activityId");
		String productCode_empty = PropertyUtil.getProInfo("parmeter", "productCode_empty");
		...
		// 定义productCode字段
		Buffer.append("\"productCode\"").append(":").append("\"").append(productCode_empty).append("\"");
		// 定义operCode字段
