 ...
 * 
 * @Description     活动同步_银行内部代码参数类型错误
 * 
 * */

public class Activity_Synchronization_Import_019_ProductCodeTypeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ProductCodeTypeError(String baseUrl)throws Exception {
		...
		String productCode_type = PropertyUtil.getProInfo("parmeter", "productCode_type");
		...
		// 定义productCode字段
		Buffer.append("\"productCode\"").append(":").append("\"").append(productCode_type).append("\"");
		// 定义operCode字段
