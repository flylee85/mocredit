 ...
 * 
 * @Description     活动同步_银行内部代码参数过短
 * 
 * */

public class Activity_Synchronization_Import_020_ShoterProductCode_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ShoterProductCode(String baseUrl)throws Exception {
		...
		String productCode_shorter = PropertyUtil.getProInfo("parmeter", "productCode_shorter");
		...
		// 定义productCode字段
		Buffer.append("\"productCode\"").append(":").append("\"").append(productCode_shorter).append("\"");
		// 定义operCode字段
