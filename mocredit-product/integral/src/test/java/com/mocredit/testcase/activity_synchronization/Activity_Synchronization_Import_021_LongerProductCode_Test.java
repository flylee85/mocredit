 ...
 * 
 * @Description     活动同步_银行内部代码参数过长
 * 
 * */

public class Activity_Synchronization_Import_021_LongerProductCode_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_LongerProductCode(String baseUrl)throws Exception {
		...
		String productCode_longer = PropertyUtil.getProInfo("parmeter", "productCode_longer");
		...
		// 定义productCode字段
		Buffer.append("\"productCode\"").append(":").append("\"").append(productCode_longer).append("\"");
		// 定义operCode字段
