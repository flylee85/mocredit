 ...
 * 
 * @Description     活动同步_银行内部代码参数为null
 * 
 * */

public class Activity_Synchronization_Import_022_ProductCodeNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ProductCodeNull(String baseUrl)throws Exception {
		...
		String productCode_null = PropertyUtil.getProInfo("parmeter", "productCode_null");
		...
		// 定义productCode字段
		Buffer.append("\"productCode\"").append(":").append("\"").append(productCode_null).append("\"");
		// 定义operCode字段
