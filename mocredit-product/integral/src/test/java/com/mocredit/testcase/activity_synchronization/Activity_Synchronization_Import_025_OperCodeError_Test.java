 ...
 * 
 * @Description     活动同步_操作代码错误
 * 
 * */

public class Activity_Synchronization_Import_025_OperCodeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_OperCodeError(String baseUrl)throws Exception {
		...
		// 定义operCode字段
		Buffer.append("\"operCode\"").append(":").append("\"").append(operCode_error).append("\"");
		// 定义startTime字段
