 ...
 * 
 * @Description     活动同步_操作代码参数为null
 * 
 * */

public class Activity_Synchronization_Import_026_OperCodeNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_OperCodeNull(String baseUrl)throws Exception {
		...
		// 定义operCode字段
		Buffer.append("\"operCode\"").append(":").append("\"").append(operCode_null).append("\"");
		// 定义startTime字段
