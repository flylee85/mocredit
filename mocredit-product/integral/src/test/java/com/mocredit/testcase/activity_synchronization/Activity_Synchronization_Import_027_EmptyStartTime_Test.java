 ...
 * 
 * @Description     活动同步_活动开始时间为空
 * 
 * */

public class Activity_Synchronization_Import_027_EmptyStartTime_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EmptyStartTime(String baseUrl)throws Exception {
		...
		String startTime_empty = PropertyUtil.getProInfo("parmeter", "startTime_empty");
		...
		// 定义startTime字段
		Buffer.append("\"startTime\"").append(":").append("\"").append(startTime_empty).append("\"");
		// 定义endTime字段
