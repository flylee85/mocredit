 ...
 * 
 * @Description     活动同步_活动开始时间错误
 * 
 * */

public class Activity_Synchronization_Import_028_StartTimeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_StartTimeError(String baseUrl)throws Exception {
		...
		String startTime_error = PropertyUtil.getProInfo("parmeter", "startTime_error");
		...
		// 定义startTime字段
		Buffer.append("\"startTime\"").append(":").append("\"").append(startTime_error).append("\"");
		// 定义endTime字段
