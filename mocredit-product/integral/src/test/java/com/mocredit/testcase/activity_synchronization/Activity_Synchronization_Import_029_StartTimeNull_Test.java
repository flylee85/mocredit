 ...
 * 
 * @Description     活动同步_活动开始时间参数为null
 * 
 * */

public class Activity_Synchronization_Import_029_StartTimeNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_StartTimeNull(String baseUrl)throws Exception {
		...
		String startTime_null = PropertyUtil.getProInfo("parmeter", "startTime_null");
		...
		// 定义startTime字段
		Buffer.append("\"startTime\"").append(":").append("\"").append(startTime_null).append("\"");
		// 定义endTime字段
