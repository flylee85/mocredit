 ...
 * 
 * @Description     活动同步_活动结束时间为空
 * 
 * */

public class Activity_Synchronization_Import_030_EmptyEndTime_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EmptyEndTime(String baseUrl)throws Exception {
		...
		String endTime_empty = PropertyUtil.getProInfo("parmeter", "endTime_empty");
		...
		// 定义endTime字段
		Buffer.append("\"endTime\"").append(":").append("\"").append(endTime_empty).append("\"");
		// 定义selectDate字段
