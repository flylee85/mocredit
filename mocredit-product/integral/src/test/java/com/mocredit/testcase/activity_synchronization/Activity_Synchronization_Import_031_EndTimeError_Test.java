 ...
 * 
 * @Description     活动同步_活动结束时间错误
 * 
 * */

public class Activity_Synchronization_Import_031_EndTimeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EndTimeError(String baseUrl)throws Exception {
		...
		String endTime_error = PropertyUtil.getProInfo("parmeter", "endTime_error");
		...
		// 定义endTime字段
		Buffer.append("\"endTime\"").append(":").append("\"").append(endTime_error).append("\"");
		// 定义selectDate字段
