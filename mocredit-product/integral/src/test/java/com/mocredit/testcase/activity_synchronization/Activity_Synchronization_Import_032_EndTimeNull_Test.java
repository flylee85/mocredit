 ...
 * 
 * @Description     活动同步_活动结束时间参数为null
 * 
 * */

public class Activity_Synchronization_Import_032_EndTimeNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EndTimeNull(String baseUrl)throws Exception {
		...
		String endTime_null = PropertyUtil.getProInfo("parmeter", "endTime_null");
		...
		// 定义endTime字段
		Buffer.append("\"endTime\"").append(":").append("\"").append(endTime_null).append("\"");
		// 定义selectDate字段
