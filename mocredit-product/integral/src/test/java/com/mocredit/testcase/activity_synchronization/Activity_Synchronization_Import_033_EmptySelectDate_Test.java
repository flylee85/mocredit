 ...
 * 
 * @Description     活动同步_指定选择日期为空
 * 
 * */

public class Activity_Synchronization_Import_033_EmptySelectDate_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EmptySelectDate(String baseUrl)throws Exception {
		...
		String selectDate_empty = PropertyUtil.getProInfo("parmeter", "selectDate_empty");
		...
		// 定义selectDate字段
		Buffer.append("\"selectDate\"").append(":").append("\"").append(selectDate_empty).append("\"");
