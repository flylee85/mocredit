 ...
 * 
 * @Description     活动同步_指定选择日期错误
 * 
 * */

public class Activity_Synchronization_Import_034_SelectDateError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_SelectDateError(String baseUrl)throws Exception {
		...
		String selectDate_error = PropertyUtil.getProInfo("parmeter", "selectDate_error");
		...
		// 定义selectDate字段
		Buffer.append("\"selectDate\"").append(":").append("\"").append(selectDate_error).append("\"");
