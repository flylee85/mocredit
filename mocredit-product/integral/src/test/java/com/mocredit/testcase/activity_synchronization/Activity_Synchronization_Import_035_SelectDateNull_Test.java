 ...
 * 
 * @Description     活动同步_指定选择日期参数为null
 * 
 * */

public class Activity_Synchronization_Import_035_SelectDateNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_SelectDateNull(String baseUrl)throws Exception {
		...
		String selectDate_null = PropertyUtil.getProInfo("parmeter", "selectDate_null");
		...
		// 定义selectDate字段
		Buffer.append("\"selectDate\"").append(":").append("\"").append(selectDate_null).append("\"");
