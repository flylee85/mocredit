 ...
 * 
 * @Description     活动同步_积分参数为空
 * 
 * */

public class Activity_Synchronization_Import_036_EmptyIntegral_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EmptyIntegral(String baseUrl)throws Exception {
		...
		String integral_empty = PropertyUtil.getProInfo("parmeter", "integral_empty");
		...
		Buffer.append("\"integral\"").append(":").append("\"").append(integral_empty).append("\"");
		// 定义maxType字段
