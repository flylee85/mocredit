 ...
 * 
 * @Description     活动同步_积分参数类型错误
 * 
 * */

public class Activity_Synchronization_Import_037_IntegralTypeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_IntegralTypeError(String baseUrl)throws Exception {
		...
		String integral_type = PropertyUtil.getProInfo("parmeter", "integral_type");
		...
		Buffer.append("\"integral\"").append(":").append("\"").append(integral_type).append("\"");
		// 定义maxType字段
