 ...
 * 
 * @Description     活动同步_积分参数长度过长
 * 
 * */

public class Activity_Synchronization_Import_039_LongerIntegral_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_LongerIntegral(String baseUrl)throws Exception {
		...
		String integral_longer = PropertyUtil.getProInfo("parmeter", "integral_longer");
		...
		Buffer.append("\"integral\"").append(":").append("\"").append(integral_longer).append("\"");
		// 定义maxType字段
