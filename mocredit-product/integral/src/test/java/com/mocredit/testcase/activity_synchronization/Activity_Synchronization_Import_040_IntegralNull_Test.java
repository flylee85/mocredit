 ...
 * 
 * @Description     活动同步_积分参数为null
 * 
 * */

public class Activity_Synchronization_Import_040_IntegralNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_IntegralNull(String baseUrl)throws Exception {
		...
		String integral_null = PropertyUtil.getProInfo("parmeter", "integral_null");
		...
		Buffer.append("\"integral\"").append(":").append("\"").append(integral_null).append("\"");
		// 定义maxType字段
