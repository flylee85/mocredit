 ...
 * 
 * @Description     活动同步_积分参数为最大长度30字符
 * 
 * */

public class Activity_Synchronization_Import_041_MaxIntegral_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_MaxIntegral(String baseUrl)throws Exception {
		...
		String integral_max = PropertyUtil.getProInfo("parmeter", "integral_max");
		...
		Buffer.append("\"integral\"").append(":").append("\"").append(integral_max).append("\"");
		// 定义maxType字段
