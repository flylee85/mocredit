 ...
 * 
 * @Description     活动同步_积分参数为负数
 * 
 * */

public class Activity_Synchronization_Import_042_IntegralNegative_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_IntegralNegative(String baseUrl)throws Exception {
		...
		String integral_negative = PropertyUtil.getProInfo("parmeter", "integral_negative");
		...
		Buffer.append("\"integral\"").append(":").append("\"").append(integral_negative).append("\"");
		// 定义maxType字段
