 ...
 * 
 * @Description     活动同步_积分参数为小数
 * 
 * */

public class Activity_Synchronization_Import_043_IntegralDecimal_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_IntegralDecimal(String baseUrl)throws Exception {
		...
		String integral_decimal = PropertyUtil.getProInfo("parmeter", "integral_decimal");
		...
		Buffer.append("\"integral\"").append(":").append("\"").append(integral_decimal).append("\"");
		// 定义maxType字段
