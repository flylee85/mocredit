 ...
 * 
 * @Description     活动同步_最大类型为空
 * 
 * */

public class Activity_Synchronization_Import_044_EmptyMaxType_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EmptyMaxType(String baseUrl)throws Exception {
		...
		String maxType_empty = PropertyUtil.getProInfo("parmeter", "maxType_empty");
		...
		// 定义maxType字段
		Buffer.append("\"maxType\"").append(":").append("\"").append(maxType_empty).append("\"");
		// 定义maxNumber字段
