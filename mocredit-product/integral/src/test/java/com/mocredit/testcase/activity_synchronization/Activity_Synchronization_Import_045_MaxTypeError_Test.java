...
public class Activity_Synchronization_Import_045_MaxTypeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	public void ActivitySynchronization_Import_MaxTypeError(String baseUrl)throws Exception {
		...
		String maxType_error = PropertyUtil.getProInfo("parmeter", "maxType_error");
		...
		// 定义maxType字段
		Buffer.append("\"maxType\"").append(":").append("\"").append(maxType_error).append("\"");
		// 定义maxNumber字段
