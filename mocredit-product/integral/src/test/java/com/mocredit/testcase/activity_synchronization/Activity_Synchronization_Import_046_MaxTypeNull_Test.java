 ...
 * 
 * @Description     活动同步_最大类型参数为null
 * 
 * */

public class Activity_Synchronization_Import_046_MaxTypeNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_MaxTypeNull(String baseUrl)throws Exception {
		...
		String maxType_null = PropertyUtil.getProInfo("parmeter", "maxType_null");
		...
		// 定义maxType字段
		Buffer.append("\"maxType\"").append(":").append("\"").append(maxType_null).append("\"");
		// 定义maxNumber字段
