 ...
 * 
 * @Description     活动同步_最大次数参数为空
 * 
 * */

public class Activity_Synchronization_Import_047_EmptyMaxNumber_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EmptyMaxNumber(String baseUrl)throws Exception {
		...
		String maxNumber_empty = PropertyUtil.getProInfo("parmeter", "maxNumber_empty");
		...
		// 定义maxNumber字段
		Buffer.append("\"maxNumber\"").append(":").append("\"").append(maxNumber_empty).append("\"");
		// 定义status字段
