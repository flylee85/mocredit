 ...
 * 
 * @Description     活动同步_最大次数参数类型错误
 * 
 * */

public class Activity_Synchronization_Import_048_MaxNumberTypeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_MaxNumberTypeError(String baseUrl)throws Exception {
		...
		String maxNumber_type = PropertyUtil.getProInfo("parmeter", "maxNumber_type");
		...
		// 定义maxNumber字段
		Buffer.append("\"maxNumber\"").append(":").append("\"").append(maxNumber_type).append("\"");
		// 定义status字段
