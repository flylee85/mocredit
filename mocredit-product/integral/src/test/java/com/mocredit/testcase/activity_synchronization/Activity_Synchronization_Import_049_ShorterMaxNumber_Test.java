 ...
 * 
 * @Description     活动同步_最大次数参数长度过短
 * 
 * */

public class Activity_Synchronization_Import_049_ShorterMaxNumber_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ShorterMaxNumber(String baseUrl)throws Exception {
		...
		String maxNumber_shorter = PropertyUtil.getProInfo("parmeter", "maxNumber_shorter");
		...
		// 定义maxNumber字段
		Buffer.append("\"maxNumber\"").append(":").append("\"").append(maxNumber_shorter).append("\"");
		// 定义status字段
