 ...
 * 
 * @Description     活动同步_最大次数参数长度过长
 * 
 * */

public class Activity_Synchronization_Import_050_LongerMaxNumber_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_LongerMaxNumber(String baseUrl)throws Exception {
		...
		String maxNumber_longer = PropertyUtil.getProInfo("parmeter", "maxNumber_longer");
		...
		// 定义maxNumber字段
		Buffer.append("\"maxNumber\"").append(":").append("\"").append(maxNumber_longer).append("\"");
		// 定义status字段
