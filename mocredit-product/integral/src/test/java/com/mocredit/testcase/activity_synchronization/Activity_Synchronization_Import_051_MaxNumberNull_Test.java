 ...
 * 
 * @Description     活动同步_最大次数参数为null
 * 
 * */

public class Activity_Synchronization_Import_051_MaxNumberNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_MaxNumberNull(String baseUrl)throws Exception {
		...
		String maxNumber_null = PropertyUtil.getProInfo("parmeter", "maxNumber_null");
		...
		// 定义maxNumber字段
		Buffer.append("\"maxNumber\"").append(":").append("\"").append(maxNumber_null).append("\"");
		// 定义status字段
