 ...
 * 
 * @Description     活动同步_活动状态为空
 * 
 * */

public class Activity_Synchronization_Import_053_EmptyStatus_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	public void ActivitySynchronization_Import_EmptyMaxType(String baseUrl)throws Exception {
		...
		String status_empty = PropertyUtil.getProInfo("parmeter", "status_empty");
		...
		// 定义status字段
		Buffer.append("\"status\"").append(":").append("\"").append(status_empty).append("\"");
		// 定义storeList开始
