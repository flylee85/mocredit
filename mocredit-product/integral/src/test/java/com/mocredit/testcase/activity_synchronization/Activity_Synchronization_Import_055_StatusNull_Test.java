...
public class Activity_Synchronization_Import_055_StatusNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	public void ActivitySynchronization_Import_MaxTypeNull(String baseUrl)throws Exception {
		...
		String status_null = PropertyUtil.getProInfo("parmeter", "status_null");
		...
		// 定义status字段
		Buffer.append("\"status\"").append(":").append("\"").append(status_null).append("\"");
		// 定义storeList开始
