 ...
 * 
 * @Description     活动同步_门店Id参数为空
 * 
 * */

public class Activity_Synchronization_Import_056_EmptyStoreId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EmptyStoreId(String baseUrl)throws Exception {
		...
		String storeId_empty = PropertyUtil.getProInfo("parmeter", "storeId_empty");
		...
		// 定义storeId字段
		Buffer.append("\"storeId\"").append(":").append("\"").append(storeId_empty).append("\"");
		// 定义shopId字段
