 ...
 * 
 * @Description     活动同步_门店Id参数类型错误
 * 
 * */

public class Activity_Synchronization_Import_057_StoreIdTypeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_StoreIdTypeError(String baseUrl)throws Exception {
		...
		String storeId_type = PropertyUtil.getProInfo("parmeter", "storeId_type");
		...
		// 定义storeId字段
		Buffer.append("\"storeId\"").append(":").append("\"").append(storeId_type).append("\"");
		// 定义shopId字段
