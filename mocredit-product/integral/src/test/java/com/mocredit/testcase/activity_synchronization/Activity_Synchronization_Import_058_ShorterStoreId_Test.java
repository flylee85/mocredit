 ...
 * 
 * @Description     活动同步_门店Id参数长度过短
 * 
 * */

public class Activity_Synchronization_Import_058_ShorterStoreId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ShorterStoreId(String baseUrl)throws Exception {
		...
		String storeId_shorter = PropertyUtil.getProInfo("parmeter", "storeId_shorter");
		...
		// 定义storeId字段
		Buffer.append("\"storeId\"").append(":").append("\"").append(storeId_shorter).append("\"");
		// 定义shopId字段
