 ...
 * 
 * @Description     活动同步_门店Id参数长度过长
 * 
 * */

public class Activity_Synchronization_Import_059_LongerStoreId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_LongerStoreId(String baseUrl)throws Exception {
		...
		String storeId_longer = PropertyUtil.getProInfo("parmeter", "storeId_longer");
		...
		// 定义storeId字段
		Buffer.append("\"storeId\"").append(":").append("\"").append(storeId_longer).append("\"");
		// 定义shopId字段
