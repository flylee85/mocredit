 ...
 * 
 * @Description     活动同步_门店Id参数为null
 * 
 * */

public class Activity_Synchronization_Import_060_StoreIdNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_StoreIdNull(String baseUrl)throws Exception {
		...
		String storeId_null = PropertyUtil.getProInfo("parmeter", "storeId_null");
		...
		// 定义storeId字段
		Buffer.append("\"storeId\"").append(":").append("\"").append(storeId_null).append("\"");
		// 定义shopId字段
