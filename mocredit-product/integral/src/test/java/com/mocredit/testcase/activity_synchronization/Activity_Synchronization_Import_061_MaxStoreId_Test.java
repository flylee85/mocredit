 ...
 * 
 * @Description     活动同步_门店Id参数为最大长度30字符
 * 
 * */

public class Activity_Synchronization_Import_061_MaxStoreId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_MaxStoreId(String baseUrl)throws Exception {
		...
		String storeId_max = PropertyUtil.getProInfo("parmeter", "storeId_max");
		...
		// 定义storeId字段
		Buffer.append("\"storeId\"").append(":").append("\"").append(storeId_max).append("\"");
		// 定义shopId字段
