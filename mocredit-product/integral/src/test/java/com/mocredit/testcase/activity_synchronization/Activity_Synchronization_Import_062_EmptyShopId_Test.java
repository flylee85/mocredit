 ...
 * 
 * @Description     活动同步_商户Id参数为空
 * 
 * */

public class Activity_Synchronization_Import_062_EmptyShopId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_EmptyShopId(String baseUrl)throws Exception {
		...
		String shopId_empty = PropertyUtil.getProInfo("parmeter", "shopId_empty");
		...
		// 定义shopId字段
		Buffer.append("\"shopId\"").append(":").append("\"").append(shopId_empty).append("\"");
		// 定义storeList结束
