 ...
 * 
 * @Description     活动同步_商户Id参数类型错误
 * 
 * */

public class Activity_Synchronization_Import_063_ShopIdError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ShopIdTypeError(String baseUrl)throws Exception {
		...
		String shopId_type = PropertyUtil.getProInfo("parmeter", "shopId_type");
		...
		// 定义shopId字段
		Buffer.append("\"shopId\"").append(":").append("\"").append(shopId_type).append("\"");
		// 定义storeList结束
