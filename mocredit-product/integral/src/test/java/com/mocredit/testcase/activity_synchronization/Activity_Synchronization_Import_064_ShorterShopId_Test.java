 ...
 * 
 * @Description     活动同步_商户Id参数长度过短
 * 
 * */

public class Activity_Synchronization_Import_064_ShorterShopId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ShorterShopId(String baseUrl)throws Exception {
		...
		String shopId_shorter = PropertyUtil.getProInfo("parmeter", "shopId_shorter");
		...
		// 定义shopId字段
		Buffer.append("\"shopId\"").append(":").append("\"").append(shopId_shorter).append("\"");
		// 定义storeList结束
