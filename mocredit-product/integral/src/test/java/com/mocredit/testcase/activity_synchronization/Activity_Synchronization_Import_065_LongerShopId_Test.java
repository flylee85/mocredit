 ...
 * 
 * @Description     活动同步_商户Id参数长度过长
 * 
 * */

public class Activity_Synchronization_Import_065_LongerShopId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_LongerShopId(String baseUrl)throws Exception {
		...
		String shopId_longer = PropertyUtil.getProInfo("parmeter", "shopId_longer");
		...
		// 定义shopId字段
		Buffer.append("\"shopId\"").append(":").append("\"").append(shopId_longer).append("\"");
		// 定义storeList结束
