 ...
 * 
 * @Description     活动同步_商户Id参数为null
 * 
 * */

public class Activity_Synchronization_Import_066_ShopIdNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ShopIdNull(String baseUrl)throws Exception {
		...
		String shopId_null = PropertyUtil.getProInfo("parmeter", "shopId_null");
		...
		// 定义shopId字段
		Buffer.append("\"shopId\"").append(":").append("\"").append(shopId_null).append("\"");
		// 定义storeList结束
