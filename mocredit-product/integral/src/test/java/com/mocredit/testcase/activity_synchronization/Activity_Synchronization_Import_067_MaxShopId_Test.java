 ...
 * 
 * @Description     活动同步_商户Id参数为最大长度30字符
 * 
 * */

public class Activity_Synchronization_Import_067_MaxShopId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_MaxShopId(String baseUrl)throws Exception {
