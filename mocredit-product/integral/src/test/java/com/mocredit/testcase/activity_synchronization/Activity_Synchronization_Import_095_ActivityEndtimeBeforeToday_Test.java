 ...
 * 
 * @Description     活动同步_导入_活动结束时间早于当前时间
 * 
 * */

public class Activity_Synchronization_Import_095_ActivityEndtimeBeforeToday_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ActivityEndtimeBeforeToday(String baseUrl)throws Exception {
		...
		String endTime_before_today = PropertyUtil.getProInfo("parmeter", "endTime_before_today");
...
//////////*********************************活动新增导入**********************************///////		
		...
		// 定义endTime字段
		Buffer.append("\"endTime\"").append(":").append("\"").append(endTime_before_today).append("\"");
		// 定义selectDate字段
