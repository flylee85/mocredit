 ...
 * 
 * @Description     活动同步_导入_活动结束时间早于开始时间
 * 
 * */

public class Activity_Synchronization_Import_096_ActivityEndtimeBeforeStarttime_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_ActivityEndtimeBeforeStarttime(String baseUrl)throws Exception {
