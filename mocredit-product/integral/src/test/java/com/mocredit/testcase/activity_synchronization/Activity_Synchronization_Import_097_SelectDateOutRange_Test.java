 ...
 * 
 * @Description     活动同步_导入_指定日期超出范围
 * 
 * */

public class Activity_Synchronization_Import_097_SelectDateOutRange_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_SelectDateOutRange(String baseUrl)throws Exception {
