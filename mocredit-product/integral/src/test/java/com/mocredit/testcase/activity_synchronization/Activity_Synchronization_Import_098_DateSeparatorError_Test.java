 ...
 * 
 * @Description     活动同步_导入_日期分割符错误
 * 
 * */

public class Activity_Synchronization_Import_098_DateSeparatorError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_DateSeparatorError(String baseUrl)throws Exception {
