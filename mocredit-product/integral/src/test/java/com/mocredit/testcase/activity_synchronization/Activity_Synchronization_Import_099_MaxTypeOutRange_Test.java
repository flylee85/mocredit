 ...
 * 
 * @Description     活动同步_导入_最大类型超出范围
 * 
 * */

public class Activity_Synchronization_Import_099_MaxTypeOutRange_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_MaxTypeOutRange(String baseUrl)throws Exception {
