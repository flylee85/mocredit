 ...
 * 
 * @Description     活动同步_导入_最大次数为负数
 * 
 * */

public class Activity_Synchronization_Import_101_MaxnumberNegative_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Import_MaxnumberNegative(String baseUrl)throws Exception {
		...
		String selectDate_mark = PropertyUtil.getProInfo("parmeter", "selectDate_mark");
		...
		String maxNumber_negative = PropertyUtil.getProInfo("parmeter", "maxNumber_negative");
...
//////////*********************************活动新增导入**********************************///////		
		...
		// 定义selectDate字段
		Buffer.append("\"selectDate\"").append(":").append("\"").append(selectDate_mark).append("\"");
		...
		// 定义maxNumber字段
		Buffer.append("\"maxNumber\"").append(":").append("\"").append(maxNumber_negative).append("\"");
		// 定义status字段
