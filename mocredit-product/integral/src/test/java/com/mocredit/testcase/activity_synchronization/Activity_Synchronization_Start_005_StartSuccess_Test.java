 ...
 * 
 * @Description     活动同步_启用单个活动
 * 
 * */

public class Activity_Synchronization_Start_005_StartSuccess_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Start_StartActivitySuccess(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId2");
		String activityName = PropertyUtil.getProInfo("parmeter", "activityName2");
...
/////////*******************************活动启动************************////
		...
		Buffer3.append("{");
		// 定义activityId字段
		Buffer3.append("\"activityId\"").append(":").append("\"").append(activityId).append("\"");
		// 定义operCode字段
