 ...
 * 
 * @Description     活动同步_启动活动_活动ID为最大长度30字符
 * 
 * */

public class Activity_Synchronization_Start_091_MaxActivityId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Start_MaxActivityId(String baseUrl)throws Exception {
...
/////////*******************************活动启动************************////
		...
		Buffer3.append("{");
		// 定义activityId字段
		Buffer3.append("\"activityId\"").append(":").append("\"").append(activityId_max).append("\"");
		// 定义operCode字段
