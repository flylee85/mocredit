 ...
 * 
 * @Description     活动同步_停止活动_操作代码为空
 * 
 * */

public class Activity_Synchronization_Start_092_EmptyOperCode_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Stop_EmptyOperCode(String baseUrl)throws Exception {
