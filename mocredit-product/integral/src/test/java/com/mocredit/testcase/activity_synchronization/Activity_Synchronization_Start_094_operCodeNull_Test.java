 ...
 * 
 * @Description     活动同步_停止活动_操作代码为NULL
 * 
 * */

public class Activity_Synchronization_Start_094_operCodeNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Stop_operCodeNull(String baseUrl)throws Exception {
