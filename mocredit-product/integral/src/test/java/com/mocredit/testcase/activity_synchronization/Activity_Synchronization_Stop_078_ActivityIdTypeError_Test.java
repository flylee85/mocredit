 ...
 * 
 * @Description     活动同步_停止活动_活动ID类型错误
 * 
 * */

public class Activity_Synchronization_Stop_078_ActivityIdTypeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Stop_ActivityIdTypeError(String baseUrl)throws Exception {
