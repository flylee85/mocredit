 ...
 * 
 * @Description     活动同步_停止活动_活动ID太长
 * 
 * */

public class Activity_Synchronization_Stop_080_LongerActivityId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Stop_LongerActivityId(String baseUrl)throws Exception {
