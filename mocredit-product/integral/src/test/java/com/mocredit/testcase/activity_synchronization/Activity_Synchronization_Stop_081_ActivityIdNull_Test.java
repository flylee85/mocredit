 ...
 * 
 * @Description     活动同步_停止活动_活动ID为NULL
 * 
 * */

public class Activity_Synchronization_Stop_081_ActivityIdNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Stop_ActivityIdNull(String baseUrl)throws Exception {
