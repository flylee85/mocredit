 ...
 * 
 * @Description     活动同步_停止活动_活动ID为最大长度30字符
 * 
 * */

public class Activity_Synchronization_Stop_082_MaxActivityId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Stop_MaxActivityId(String baseUrl)throws Exception {
