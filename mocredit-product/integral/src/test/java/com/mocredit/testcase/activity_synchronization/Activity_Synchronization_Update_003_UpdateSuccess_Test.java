 ...
 * 
 * @Description     活动同步_同步更新单个活动
 * 
 * */

public class Activity_Synchronization_Update_003_UpdateSuccess_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Update_UpdateActivitySuccess(String baseUrl)throws Exception {
