 ...
 * 
 * @Description     活动同步_更新_活动ID为空
 * 
 * */

public class Activity_Synchronization_Update_068_EemptyActivityId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Update_EemptyActivityId(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityId_empty = PropertyUtil.getProInfo("parmeter", "activityId_empty");		
...
//////////*********************************活动更新**********************************///////		
		...
		Buffer2.append("{");
		// 定义activityId字段
		Buffer2.append("\"activityId\"").append(":").append("\"").append(activityId_empty).append("\"");
		// 定义activityName字段
