 ...
 * 
 * @Description     活动同步_更新_活动ID参数类型错误
 * 
 * */

public class Activity_Synchronization_Update_069_ActivityIdTypeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Update_ActivityIdTypeError(String baseUrl)throws Exception {
...
//////////*********************************活动更新**********************************///////		
		...
		Buffer2.append("{");
		// 定义activityId字段
		Buffer2.append("\"activityId\"").append(":").append("\"").append(activityId_type).append("\"");
		// 定义activityName字段
