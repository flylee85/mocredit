 ...
 * 
 * @Description     活动同步_更新_活动ID参数过短
 * 
 * */

public class Activity_Synchronization_Update_070_ShorterActivityId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Update_ShorterActivityId(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityId_shorter = PropertyUtil.getProInfo("parmeter", "activityId_shorter");				
		...
		String operCode_update = PropertyUtil.getProInfo("parmeter", "operCode_update");
		...
		String maxType_everymonth = PropertyUtil.getProInfo("parmeter", "maxType_everymonth");
		String maxType_nolimit = PropertyUtil.getProInfo("parmeter", "maxType_nolimit");
		...
		String status_disable = PropertyUtil.getProInfo("parmeter", "status_disable");		
...
//////////*********************************活动新增导入**********************************///////		
		...
		// 定义maxType字段
		Buffer.append("\"maxType\"").append(":").append("\"").append(maxType_everymonth).append("\"");
		// 定义maxNumber字段
...
//////////*********************************活动更新**********************************///////		
		...
		Buffer2.append("{");
		// 定义activityId字段
		Buffer2.append("\"activityId\"").append(":").append("\"").append(activityId_shorter).append("\"");
		// 定义activityName字段
		Buffer2.append("\"activityName\"").append(":").append("\"").append(activityName).append("\"");
		// 定义productCode字段
		Buffer2.append("\"productCode\"").append(":").append("\"").append(productCode).append("\"");
		// 定义operCode字段
		Buffer2.append("\"operCode\"").append(":").append("\"").append(operCode_update).append("\"");
		// 定义startTime字段
		Buffer2.append("\"startTime\"").append(":").append("\"").append(startTime).append("\"");
		// 定义endTime字段
		Buffer2.append("\"endTime\"").append(":").append("\"").append(endTime).append("\"");
		// 定义selectDate字段
		Buffer2.append("\"selectDate\"").append(":").append("\"").append(selectDate_sigle).append("\"");
		// 定义storeNintegralame字段
		Buffer2.append("\"integral\"").append(":").append("\"").append(integral).append("\"");
		// 定义maxType字段
		Buffer2.append("\"maxType\"").append(":").append("\"").append(maxType_nolimit).append("\"");
		// 定义maxNumber字段
		Buffer2.append("\"maxNumber\"").append(":").append("\"").append(maxNumber).append("\"");
		// 定义status字段
		Buffer2.append("\"status\"").append(":").append("\"").append(status_disable).append("\"");
		// 定义storeList开始
		Buffer2.append("\"storeList\"").append(":").append("[").append("{");
		// 定义storeId字段
		Buffer2.append("\"storeId\"").append(":").append("\"").append(storeId).append("\"");
		// 定义shopId字段
		Buffer2.append("\"shopId\"").append(":").append("\"").append(shopId).append("\"");
		// 定义storeList结束
