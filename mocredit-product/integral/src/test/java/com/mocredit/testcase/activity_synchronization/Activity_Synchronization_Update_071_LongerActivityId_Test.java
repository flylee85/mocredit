...
public class Activity_Synchronization_Update_071_LongerActivityId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Update_LongerActivityId(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityId_longer = PropertyUtil.getProInfo("parmeter", "activityId_longer");				
...
//////////*********************************活动更新**********************************///////		
		...
		Buffer2.append("{");
		// 定义activityId字段
		Buffer2.append("\"activityId\"").append(":").append("\"").append(activityId_longer).append("\"");
		// 定义activityName字段
