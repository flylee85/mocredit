 ...
 * 
 * @Description     活动同步_更新_活动ID参数为Null
 * 
 * */

public class Activity_Synchronization_Update_072_ActivityIdNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Update_ActivityIdNull(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityId_null = PropertyUtil.getProInfo("parmeter", "activityId_null");				
...
//////////*********************************活动更新**********************************///////		
		...
		Buffer2.append("{");
		// 定义activityId字段
		Buffer2.append("\"activityId\"").append(":").append("\"").append(activityId_null).append("\"");
		// 定义activityName字段
