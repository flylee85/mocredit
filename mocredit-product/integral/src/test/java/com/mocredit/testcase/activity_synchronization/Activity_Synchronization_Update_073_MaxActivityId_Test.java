 ...
 * 
 * @Description     活动同步_更新_活动ID参数为最大长度30字符
 * 
 * */

public class Activity_Synchronization_Update_073_MaxActivityId_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Update_MaxActivityId(String baseUrl)throws Exception {
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String activityId_max = PropertyUtil.getProInfo("parmeter", "activityId_max");				
...
//////////*********************************活动更新**********************************///////		
		...
		Buffer2.append("{");
		// 定义activityId字段
		Buffer2.append("\"activityId\"").append(":").append("\"").append(activityId_max).append("\"");
		// 定义activityName字段
