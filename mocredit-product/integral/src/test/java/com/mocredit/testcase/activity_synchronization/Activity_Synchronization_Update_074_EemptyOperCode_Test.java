 ...
 * 
 * @Description     活动同步_更新_操作代码为空
 * 
 * */

public class Activity_Synchronization_Update_074_EemptyOperCode_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Update_EemptyOperCode(String baseUrl)throws Exception {
		...
		String operCode_empty = PropertyUtil.getProInfo("parmeter", "operCode_empty");
...
//////////*********************************活动更新**********************************///////		
		...
		// 定义operCode字段
		Buffer2.append("\"operCode\"").append(":").append("\"").append(operCode_empty).append("\"");
		// 定义startTime字段
