 ...
 * 
 * @Description     活动同步_更新_操作代码参数错误
 * 
 * */

public class Activity_Synchronization_Update_075_OperCodeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Update_OperCodeError(String baseUrl)throws Exception {
		...
		String operCode_null = PropertyUtil.getProInfo("parmeter", "operCode_null");
...
//////////*********************************活动更新**********************************///////		
		...
		// 定义operCode字段
		Buffer2.append("\"operCode\"").append(":").append("\"").append(operCode_null).append("\"");
		// 定义startTime字段
