 ...
 * 
 * @Description     活动同步_更新_操作代码参数为Null
 * 
 * */

public class Activity_Synchronization_Update_076_OperCodeNull_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_Update_OperCodeNull(String baseUrl)throws Exception {
		...
		String operCode_error = PropertyUtil.getProInfo("parmeter", "operCode_error");
...
//////////*********************************活动更新**********************************///////		
		...
		// 定义operCode字段
		Buffer2.append("\"operCode\"").append(":").append("\"").append(operCode_error).append("\"");
		// 定义startTime字段
