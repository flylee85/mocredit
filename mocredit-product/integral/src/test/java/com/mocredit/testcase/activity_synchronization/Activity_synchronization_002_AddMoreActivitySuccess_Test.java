...
public class Activity_synchronization_002_AddMoreActivitySuccess_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_AddMoreActivitySuccess_Test(String baseUrl)throws Exception {
