...
public class Activity_synchronization_003_UpdateActivitySuccess_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_UpdateActivitySuccess(String baseUrl)throws Exception {
		...
		// 定义operCode字段
		Buffer.append("\"operCode\"").append(":").append("\"").append(operCode_update).append("\"");
		// 定义startTime字段
