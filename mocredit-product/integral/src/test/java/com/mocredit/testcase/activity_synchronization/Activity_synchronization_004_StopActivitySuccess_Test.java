 ...
 * 
 * @Description     活动同步_停止单个活动
 * 
 * */

public class Activity_synchronization_004_StopActivitySuccess_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_StopActivitySuccess(String baseUrl)throws Exception {
