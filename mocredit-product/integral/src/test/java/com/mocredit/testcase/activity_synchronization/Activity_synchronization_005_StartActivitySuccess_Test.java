...
public class Activity_synchronization_005_StartActivitySuccess_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_StartActivitySuccess(String baseUrl)throws Exception {
