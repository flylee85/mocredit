...
public class Activity_synchronization_007_ActivityIdTypeError_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_ActivityIdTypeError(String baseUrl)throws Exception {
