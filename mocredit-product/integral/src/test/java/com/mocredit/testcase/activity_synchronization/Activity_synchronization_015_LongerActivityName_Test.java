...
public class Activity_synchronization_015_LongerActivityName_Test {
	/**
	 * 活动同步参数列表
	 * 
     *  activityId     活动ID
	...
	@Test
	public void ActivitySynchronization_LongerActivityName(String baseUrl)throws Exception {
