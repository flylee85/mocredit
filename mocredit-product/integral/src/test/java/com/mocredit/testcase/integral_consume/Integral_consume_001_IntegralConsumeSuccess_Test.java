...
public class Integral_consume_001_IntegralConsumeSuccess_Test {
	...
	@Test
	public void IntegralCounseme_CounsemeSuccess(String baseUrl, String paymentUrl)throws Exception {
		Random r = new Random();
