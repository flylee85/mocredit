 ...
 * 
 * @Description     积分消费接口正常测试
 * 
 * */

public class Integral_consume_002_InterfaceUnblocked_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_InterfaceUnblocked(String baseUrl)throws Exception {
		Random r = new Random();
