 ...
 * 
 * @Description     积分消费接口异常测试
 * 
 * */

public class Integral_consume_003_InterfaceBlocked_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_InterfaceBlocked(String baseUrl)throws Exception {
		Random r = new Random();
		...
		Assert.assertEquals(response.getErrorMsg(), "请求Bank出错");
	}
}
