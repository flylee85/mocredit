 ...
 * 
 * @Description     积分消费_银行参数为空
 * 
 * */

public class Integral_consume_004_EmptyBankNum_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_EmptyBankNum(String baseUrl)throws Exception {
		Random r = new Random();
		int i = 1 + r.nextInt(9000);
		String bank = PropertyUtil.getProInfo("parmeter", "bank_empty");
