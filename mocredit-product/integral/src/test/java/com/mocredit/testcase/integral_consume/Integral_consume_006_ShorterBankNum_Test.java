 ...
 * 
 * @Description     积分消费_银行参数过短
 * 
 * */

public class Integral_consume_006_ShorterBankNum_Test {
	...
	@Test
	public void IntegralConsume_ShorterBankNum(String baseUrl)throws Exception {
		Random r = new Random();
		int i = 1 + r.nextInt(9000);
		String bank = PropertyUtil.getProInfo("parmeter", "bank_shorter");
