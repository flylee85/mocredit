 ...
 * 
 * @Description     积分消费_终端号参数为空
 * 
 * */

public class Integral_consume_011_EmptyDeviceNum_Test {
	...
	@Test
	public void IntegralConsume_EmptyDeviceNum(String baseUrl)throws Exception {
		Random r = new Random();
		int i = 1 + r.nextInt(9000);
		String bank = PropertyUtil.getProInfo("parmeter", "bank_citic");
		String device = PropertyUtil.getProInfo("parmeter", "device_empty");
