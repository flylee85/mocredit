 ...
 * 
 * @Description     积分消费_终端参数为NULL
 * 
 * */

public class Integral_consume_015_DeviceNumNull_Test {
	...
	@Test
	public void IntegralConsume_DeviceNumNull(String baseUrl)throws Exception {
		Random r = new Random();
		int i = 1 + r.nextInt(9000);
		String bank = PropertyUtil.getProInfo("parmeter", "bank_citic");
		String device = PropertyUtil.getProInfo("parmeter", "device_null");
