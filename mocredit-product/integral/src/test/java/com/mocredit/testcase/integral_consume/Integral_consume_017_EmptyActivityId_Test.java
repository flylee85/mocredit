 ...
 * 
 * @Description     积分消费_活动ID参数为空
 * 
 * */

public class Integral_consume_017_EmptyActivityId_Test {
	...
	@Test
	public void IntegralConsume_EmptyActivityId(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId_empty");
