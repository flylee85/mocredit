 ...
 * 
 * @Description     积分消费_活动ID参数类型错误
 * 
 * */

public class Integral_consume_018_ActivityIdTypeError_Test {
	...
	@Test
	public void IntegralConsume_ActivityIdTypeError(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId_type");
