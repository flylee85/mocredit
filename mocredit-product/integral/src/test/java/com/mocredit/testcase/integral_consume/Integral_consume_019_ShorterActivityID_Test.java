 ...
 * 
 * @Description     积分消费_活动ID参数过短
 * 
 * */

public class Integral_consume_019_ShorterActivityID_Test {
	...
	@Test
	public void IntegralConsume_ShorterActivityID(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId_shorter");
