 ...
 * 
 * @Description     积分消费_活动ID参数过长
 * 
 * */

public class Integral_consume_020_LongerActivityID_Test {
	...
	@Test
	public void IntegralConsume_LongerActivityID(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId_longer");
