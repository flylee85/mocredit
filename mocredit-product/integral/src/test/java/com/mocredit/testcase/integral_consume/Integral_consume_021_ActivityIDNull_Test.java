 ...
 * 
 * @Description     积分消费_活动ID参数为NULL
 * 
 * */

public class Integral_consume_021_ActivityIDNull_Test {
	...
	@Test
	public void IntegralConsume_ActivityIDNull(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId_null");
