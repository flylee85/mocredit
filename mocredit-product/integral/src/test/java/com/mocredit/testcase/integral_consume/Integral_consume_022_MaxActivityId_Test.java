 ...
 * 
 * @Description     积分消费_活动ID参数为最大长度30
 * 
 * */

public class Integral_consume_022_MaxActivityId_Test {
	...
	@Test
	public void IntegralConsume_MaxActivityId(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId_max");
