 ...
 * 
 * @Description     积分消费_订单号参数过短
 * 
 * */

public class Integral_consume_025_ShorterOrderId_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_ShorterOrderId(String baseUrl)throws Exception {
