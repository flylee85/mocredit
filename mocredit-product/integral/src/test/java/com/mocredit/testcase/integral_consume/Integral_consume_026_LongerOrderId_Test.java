 ...
 * 
 * @Description     积分消费_订单号参数过长
 * 
 * */

public class Integral_consume_026_LongerOrderId_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_LongerOrderId(String baseUrl)throws Exception {
		String bank = PropertyUtil.getProInfo("parmeter", "bank_citic");
		String device = PropertyUtil.getProInfo("parmeter", "device");
		String orderId = "99999999999999999999999999999999999";
