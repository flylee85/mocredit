...
public class Integral_consume_028_MaxOrderId_Test {
	...
	@Test
	public void IntegralConsume_MaxOrderId(String baseUrl)throws Exception {
//		Random r = new Random();
//		int i = 1 + r.nextInt(9000);
		...
		String orderId = "hegytest9999999999999999999999";
