 ...
 * 
 * @Description     积分消费_销售商户号参数为空
 * 
 * */

public class Integral_consume_029_EmptyShopId_Test {
	...
	@Test
	public void IntegralConsume_EmptyShopId(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String shopId = PropertyUtil.getProInfo("parmeter", "shopId_empty");
