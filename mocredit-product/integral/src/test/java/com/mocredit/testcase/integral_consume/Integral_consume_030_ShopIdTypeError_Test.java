 ...
 * 
 * @Description     积分消费_销售商户号参数类型错误
 * 
 * */

public class Integral_consume_030_ShopIdTypeError_Test {
	...
	@Test
	public void IntegralConsume_ShopIdTypeError(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String shopId = PropertyUtil.getProInfo("parmeter", "shopId_type");
