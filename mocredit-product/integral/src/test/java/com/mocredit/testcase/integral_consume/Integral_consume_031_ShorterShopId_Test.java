 ...
 * 
 * @Description     积分消费_销售商户号参数过短
 * 
 * */

public class Integral_consume_031_ShorterShopId_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_ShorterShopId(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String shopId = PropertyUtil.getProInfo("parmeter", "shopId_shorter");
