 ...
 * 
 * @Description     积分消费_销售商户号参数过长
 * 
 * */

public class Integral_consume_032_LongerShopId_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_LongerShopId(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String shopId = PropertyUtil.getProInfo("parmeter", "shopId_longer");
