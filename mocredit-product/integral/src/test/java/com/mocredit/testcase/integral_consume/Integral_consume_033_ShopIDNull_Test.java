 ...
 * 
 * @Description     积分消费_销售商户号参数为NULL
 * 
 * */

public class Integral_consume_033_ShopIDNull_Test {
	...
	@Test
	public void IntegralConsume_ShopIDNull(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String shopId = PropertyUtil.getProInfo("parmeter", "shopId_null");
