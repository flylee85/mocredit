 ...
 * 
 * @Description     积分消费_销售商户名参数为空
 * 
 * */

public class Integral_consume_035_EmptyShopName_Test {
	...
	@Test
	public void IntegralConsume_EmptyShopName(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String shopName = PropertyUtil.getProInfo("parmeter", "shopName_empty");
