 ...
 * 
 * @Description     积分消费_销售商户名参数类型错误
 * 
 * */

public class Integral_consume_036_ShopNameTypeError_Test {
	...
	@Test
	public void IntegralConsume_ShopNameTypeError(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String shopName = PropertyUtil.getProInfo("parmeter", "shopName_type");
