 ...
 * 
 * @Description     积分消费_销售商户名参数过短
 * 
 * */

public class Integral_consume_037_ShorterShopName_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_ShorterShopName(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String shopName = PropertyUtil.getProInfo("parmeter", "shopName_shorter");
