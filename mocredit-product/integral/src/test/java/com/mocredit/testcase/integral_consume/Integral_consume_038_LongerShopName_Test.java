 ...
 * 
 * @Description     积分消费_销售商户名参数过长
 * 
 * */

public class Integral_consume_038_LongerShopName_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_LongerShopName(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String shopName = PropertyUtil.getProInfo("parmeter", "shopName_longer");
