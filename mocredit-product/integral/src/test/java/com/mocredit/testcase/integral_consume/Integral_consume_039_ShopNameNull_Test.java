 ...
 * 
 * @Description     积分消费_销售商户名参数为NULL
 * 
 * */

public class Integral_consume_039_ShopNameNull_Test {
	...
	@Test
	public void IntegralConsume_ShopNameNull(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String shopName = PropertyUtil.getProInfo("parmeter", "shopName_null");
