 ...
 * 
 * @Description     积分消费_销售商户名参数为最大长度30
 * 
 * */

public class Integral_consume_040_MaxShopName_Test {
	...
	@Test
	public void IntegralConsume_MaxShopName(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String shopName = PropertyUtil.getProInfo("parmeter", "shopName_max");
