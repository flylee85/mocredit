 ...
 * 
 * @Description     积分消费_门店ID参数为空
 * 
 * */

public class Integral_consume_041_EmptyStoreId_Test {
	...
	@Test
	public void IntegralConsume_EmptyStoreId(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeId = PropertyUtil.getProInfo("parmeter", "storeId_empty");
