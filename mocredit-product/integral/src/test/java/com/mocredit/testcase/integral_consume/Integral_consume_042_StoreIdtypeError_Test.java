 ...
 * 
 * @Description     积分消费_门店ID参数类型错误
 * 
 * */

public class Integral_consume_042_StoreIdtypeError_Test {
	...
	@Test
	public void IntegralConsume_StoreIdTypeError(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeId = PropertyUtil.getProInfo("parmeter", "storeId_type");
