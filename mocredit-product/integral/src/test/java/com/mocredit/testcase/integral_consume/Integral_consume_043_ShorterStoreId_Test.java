 ...
 * 
 * @Description     积分消费_门店ID参数过短
 * 
 * */

public class Integral_consume_043_ShorterStoreId_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_ShorterStoreId(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeId = PropertyUtil.getProInfo("parmeter", "storeId_shorter");
