 ...
 * 
 * @Description     积分消费_门店ID参数过长
 * 
 * */

public class Integral_consume_044_LongerStoreId_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_LongerStoreId(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeId = PropertyUtil.getProInfo("parmeter", "storeId_longer");
