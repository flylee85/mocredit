 ...
 * 
 * @Description     积分消费_门店ID参数为NULL
 * 
 * */

public class Integral_consume_045_StoreIdNull_Test {
	...
	@Test
	public void IntegralConsume_StoreIdNull(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeId = PropertyUtil.getProInfo("parmeter", "storeId_null");
