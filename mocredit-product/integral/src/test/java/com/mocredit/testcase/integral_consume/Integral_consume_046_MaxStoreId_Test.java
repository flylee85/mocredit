 ...
 * 
 * @Description     积分消费_门店ID参数为最大长度30
 * 
 * */

public class Integral_consume_046_MaxStoreId_Test {
	...
	@Test
	public void IntegralConsume_MaxStoreId(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeId = PropertyUtil.getProInfo("parmeter", "storeId_max");
