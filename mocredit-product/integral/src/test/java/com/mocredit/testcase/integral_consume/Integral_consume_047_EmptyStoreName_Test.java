 ...
 * 
 * @Description     积分消费_门店名称参数为空
 * 
 * */

public class Integral_consume_047_EmptyStoreName_Test {
	...
	@Test
	public void IntegralConsume_EmptyStoreName(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeName = PropertyUtil.getProInfo("parmeter", "storeName_empty");
