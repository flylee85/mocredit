 ...
 * 
 * @Description     积分消费_门店名称参数类型错误
 * 
 * */

public class Integral_consume_048_StoreNametypeError_Test {
	...
	@Test
	public void IntegralConsume_StoreNameTypeError(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeName = PropertyUtil.getProInfo("parmeter", "storeName_type");
