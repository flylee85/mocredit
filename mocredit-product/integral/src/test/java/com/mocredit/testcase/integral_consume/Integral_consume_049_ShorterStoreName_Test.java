 ...
 * 
 * @Description     积分消费_门店名称参数过短
 * 
 * */

public class Integral_consume_049_ShorterStoreName_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_ShorterStoreName(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeName = PropertyUtil.getProInfo("parmeter", "storeName_shorter");
