 ...
 * 
 * @Description     积分消费_门店名称参数过长
 * 
 * */

public class Integral_consume_050_LongerStoreName_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_LongerStoreName(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeName = PropertyUtil.getProInfo("parmeter", "storeName_longer");
