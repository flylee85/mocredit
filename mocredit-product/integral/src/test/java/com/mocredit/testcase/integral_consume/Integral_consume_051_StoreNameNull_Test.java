 ...
 * 
 * @Description     积分消费_门店名称参数为NULL
 * 
 * */

public class Integral_consume_051_StoreNameNull_Test {
	...
	@Test
	public void IntegralConsume_StoreNameNull(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeName = PropertyUtil.getProInfo("parmeter", "storeName_null");
