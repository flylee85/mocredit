 ...
 * 
 * @Description     积分消费_门店名称参数为最大长度30
 * 
 * */

public class Integral_consume_052_MaxStoreName_Test {
	...
	@Test
	public void IntegralConsume_MaxStoreName(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String storeName = PropertyUtil.getProInfo("parmeter", "storeName_max");
