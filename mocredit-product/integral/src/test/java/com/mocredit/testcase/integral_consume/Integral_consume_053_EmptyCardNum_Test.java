 ...
 * 
 * @Description     积分消费_卡号参数为空
 * 
 * */

public class Integral_consume_053_EmptyCardNum_Test {
	...
	@Test
	public void IntegralConsume_EmptyCardNum(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String cardNum = PropertyUtil.getProInfo("parmeter", "cardNum_empty");
