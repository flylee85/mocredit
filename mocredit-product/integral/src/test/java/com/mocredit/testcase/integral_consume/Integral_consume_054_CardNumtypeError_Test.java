 ...
 * 
 * @Description     积分消费_卡号参数类型错误
 * 
 * */

public class Integral_consume_054_CardNumtypeError_Test {
	...
	@Test
	public void IntegralConsume_CardNumTypeError(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String cardNum = PropertyUtil.getProInfo("parmeter", "cardNum_type");
