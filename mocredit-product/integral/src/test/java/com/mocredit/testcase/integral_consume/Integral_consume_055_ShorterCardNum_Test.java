 ...
 * 
 * @Description     积分消费_卡号参数过短
 * 
 * */

public class Integral_consume_055_ShorterCardNum_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_ShorterCardNum(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String cardNum = PropertyUtil.getProInfo("parmeter", "cardNum_shorter");
