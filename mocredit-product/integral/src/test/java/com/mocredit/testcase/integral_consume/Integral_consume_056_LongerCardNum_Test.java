 ...
 * 
 * @Description     积分消费_卡号参数过长
 * 
 * */

public class Integral_consume_056_LongerCardNum_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_LongerCardNum(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String cardNum = PropertyUtil.getProInfo("parmeter", "cardNum_longer");
