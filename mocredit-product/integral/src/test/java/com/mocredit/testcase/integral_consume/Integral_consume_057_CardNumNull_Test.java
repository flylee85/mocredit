 ...
 * 
 * @Description     积分消费_卡号参数为NULL
 * 
 * */

public class Integral_consume_057_CardNumNull_Test {
	...
	@Test
	public void IntegralConsume_CardNumNull(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String cardNum = PropertyUtil.getProInfo("parmeter", "cardNum_null");
