 ...
 * 
 * @Description     积分消费_卡号参数为最大长度30
 * 
 * */

public class Integral_consume_058_MaxCardNum_Test {
	...
	@Test
	public void IntegralConsume_MaxCardNum(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String cardNum = PropertyUtil.getProInfo("parmeter", "cardNum_max");
