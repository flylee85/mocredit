 ...
 * 
 * @Description     积分消费_消费积分参数为空
 * 
 * */

public class Integral_consume_059_EmptyIntegralNum_Test {
	...
	@Test
	public void IntegralConsume_EmptyIntegralNum(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String integral = PropertyUtil.getProInfo("parmeter", "integral_empty");
