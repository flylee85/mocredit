 ...
 * 
 * @Description     积分消费_消费积分参数类型错误
 * 
 * */

public class Integral_consume_060_IntegralNumtypeError_Test {
	...
	@Test
	public void IntegralConsume_IntegralNumTypeError(String baseUrl)throws Exception {
		Random r = new Random();
