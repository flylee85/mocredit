 ...
 * 
 * @Description     积分消费_消费积分参数过短
 * 
 * */

public class Integral_consume_061_ShorterIntegralNum_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_ShorterIntegralNum(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String integral = PropertyUtil.getProInfo("parmeter", "integral_shorter");
