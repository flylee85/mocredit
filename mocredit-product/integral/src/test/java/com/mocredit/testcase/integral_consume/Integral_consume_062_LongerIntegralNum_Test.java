 ...
 * 
 * @Description     积分消费_消费积分参数过长
 * 
 * */

public class Integral_consume_062_LongerIntegralNum_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsume_LongerIntegralNum(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String integral = PropertyUtil.getProInfo("parmeter", "integral_longer");
