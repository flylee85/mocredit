 ...
 * 
 * @Description     积分消费_消费积分参数为NULL
 * 
 * */

public class Integral_consume_063_IntegralNumNull_Test {
	...
	@Test
	public void IntegralConsume_IntegralNumNull(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String integral = PropertyUtil.getProInfo("parmeter", "integral_null");
