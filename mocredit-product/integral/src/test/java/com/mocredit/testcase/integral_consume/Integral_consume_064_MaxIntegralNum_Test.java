 ...
 * 
 * @Description     积分消费_消费积分参数为最大长度30
 * 
 * */

public class Integral_consume_064_MaxIntegralNum_Test {
	...
	@Test
	public void IntegralConsume_MaxIntegralNum(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String integral = PropertyUtil.getProInfo("parmeter", "integral_max");
