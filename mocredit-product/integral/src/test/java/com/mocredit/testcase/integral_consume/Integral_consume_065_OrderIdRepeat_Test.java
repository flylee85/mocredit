 ...
 * 
 * @Description     积分消费_OrderId重复
 * 
 * */

public class Integral_consume_065_OrderIdRepeat_Test {
	...
	@Test
	public void IntegralConsume_OrderIdRepeat(String baseUrl)throws Exception {
		Random r = new Random();
		...
		Assert.assertEquals(response1.getErrorCode(), "508");
		Assert.assertEquals(response1.getErrorMsg(), "已存在该订单");
