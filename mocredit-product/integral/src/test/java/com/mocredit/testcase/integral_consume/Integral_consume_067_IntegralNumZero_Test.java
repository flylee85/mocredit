 ...
 * 
 * @Description     积分消费_积分为零
 * 
 * */

public class Integral_consume_067_IntegralNumZero_Test {
	...
	@Test
	public void IntegralConsume_IntegralNumZero(String baseUrl)throws Exception {
		Random r = new Random();
