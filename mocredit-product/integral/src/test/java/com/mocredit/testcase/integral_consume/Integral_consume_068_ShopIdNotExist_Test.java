 ...
 * 
 * @Description     积分消费_商户号不存在
 * 
 * */

public class Integral_consume_068_ShopIdNotExist_Test {
	...
	@Test
	public void IntegralConsume_ShopIdNotExist(String baseUrl)throws Exception {
		Random r = new Random();
		...
		Assert.assertEquals(response1.getErrorCode(), "007");
		Assert.assertEquals(response1.getErrorMsg(), "该商户没有权限");
