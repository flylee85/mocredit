 ...
 * 
 * @Description     积分消费冲正_冲正成功
 * 
 * */

public class Integral_consume_correct_001_CorrectSuccess_Test {
	/**
	 *积分消费参数列表
	 * 
	...
	@Test
	public void IntegralConsumeCorrect_CorrectSuccess(String baseUrl)throws Exception {
		Random r = new Random();
