 ...
 * 
 * @Description     积分消费冲正_终端号参数为空
 * 
 * */

public class Integral_consume_correct_002_EmptyDeviceNum_Test {
	...
	@Test
	public void IntegralConsumeCorrect_EmptyDeviceNum(String baseUrl)throws Exception {
		Random r = new Random();
...
////////定义积分消费冲正缓冲区
		...
		Buffer2.append("{");
		// 定义cardNum字段
		Buffer2.append("\"device\"").append(":").append("\"").append(device_empty).append("\"");
		// 定义integral字段
