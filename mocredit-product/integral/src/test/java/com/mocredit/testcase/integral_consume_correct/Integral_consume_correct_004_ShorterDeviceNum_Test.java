 ...
 * 
 * @Description     积分消费冲正_终端号参数过短
 * 
 * */

public class Integral_consume_correct_004_ShorterDeviceNum_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsumeCorrect_ShorterDeviceNum(String baseUrl)throws Exception {
		Random r = new Random();
...
////////定义积分消费冲正缓冲区
		...
		Buffer2.append("{");
		// 定义cardNum字段
		Buffer2.append("\"device\"").append(":").append("\"").append(device_shorter).append("\"");
		// 定义integral字段
