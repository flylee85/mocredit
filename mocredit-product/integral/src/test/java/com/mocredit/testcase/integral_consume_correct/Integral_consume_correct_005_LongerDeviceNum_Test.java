 ...
 * 
 * @Description      积分消费冲正_终端号参数过长
 * 
 * */

public class Integral_consume_correct_005_LongerDeviceNum_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsumeCorrect_LongerDeviceNum(String baseUrl)throws Exception {
		Random r = new Random();
