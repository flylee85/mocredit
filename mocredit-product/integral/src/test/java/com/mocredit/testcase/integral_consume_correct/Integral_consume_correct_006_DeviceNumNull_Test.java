 ...
 * 
 * @Description     积分消费冲正_终端号参数为NULL
 * 
 * */

public class Integral_consume_correct_006_DeviceNumNull_Test {
	...
	@Test
	public void IntegralConsumeCorrect_DeviceNumNull(String baseUrl)throws Exception {
		Random r = new Random();
...
////////定义积分消费冲正缓冲区
		...
		Buffer2.append("{");
		// 定义cardNum字段
		Buffer2.append("\"device\"").append(":").append("\"").append(device_null).append("\"");
		// 定义integral字段
