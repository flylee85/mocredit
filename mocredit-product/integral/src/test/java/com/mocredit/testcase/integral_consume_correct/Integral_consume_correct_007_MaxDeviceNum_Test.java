 ...
 * 
 * @Description     积分消费冲正_终端号参数为最大长度30
 * 
 * */

public class Integral_consume_correct_007_MaxDeviceNum_Test {
	...
	@Test
	public void IntegralConsumeCorrect_MaxDeviceNum(String baseUrl)throws Exception {
		Random r = new Random();
