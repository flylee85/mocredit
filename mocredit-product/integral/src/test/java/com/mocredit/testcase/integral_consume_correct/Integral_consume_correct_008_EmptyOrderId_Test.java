 ...
 * 
 * @Description     积分消费冲正_原订单号参数为空
 * 
 * */

public class Integral_consume_correct_008_EmptyOrderId_Test {
	...
	@Test
	public void IntegralConsumeCorrect_EmptyOrderId(String baseUrl)throws Exception {
		Random r = new Random();
...
////////定义积分消费冲正缓冲区
		...
		// 定义integral字段
		Buffer2.append("\"orderId\"").append(":").append("\"").append(orderId_empty).append("\"");
		// 定义缓冲区结束
		Buffer2.append("}");
		// 字符串转换成jsonStr
