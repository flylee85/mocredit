 ...
 * 
 * @Description      积分消费冲正_原订单号参数过长
 * 
 * */

public class Integral_consume_correct_011_LongerOrderId_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsumeCorrect_LongerOrderId(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String orderId_longer = "77777777777777777777777777777777777";
