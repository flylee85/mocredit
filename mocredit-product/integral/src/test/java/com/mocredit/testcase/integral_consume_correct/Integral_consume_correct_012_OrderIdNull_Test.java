 ...
 * 
 * @Description     积分消费冲正_原订单号参数为NULL
 * 
 * */

public class Integral_consume_correct_012_OrderIdNull_Test {
	...
	@Test
	public void IntegralConsumeCorrect_OrderIdNull(String baseUrl)throws Exception {
		Random r = new Random();
...
////////定义积分消费冲正缓冲区
		...
		// 定义integral字段
		Buffer2.append("\"orderId\"").append(":").append("\"").append(orderId_null).append("\"");
		// 定义缓冲区结束
		Buffer2.append("}");
		// 字符串转换成jsonStr
