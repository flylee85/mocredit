 ...
 * 
 * @Description     积分消费冲正_原订单号参数为最大长度30
 * 
 * */

public class Integral_consume_correct_013_MaxOrderId_Test {
	...
	@Test
	public void IntegralConsumeCorrect_MaxOrderId(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String orderId_max = "888888888888888888888888888888";
...
////////定义积分消费冲正缓冲区
		...
		// 定义integral字段
		Buffer2.append("\"orderId\"").append(":").append("\"").append(orderId_max).append("\"");
		// 定义缓冲区结束
		Buffer2.append("}");
		// 字符串转换成jsonStr
