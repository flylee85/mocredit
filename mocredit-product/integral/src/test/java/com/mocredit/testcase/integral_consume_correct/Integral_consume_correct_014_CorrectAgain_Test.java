 ...
 * 
 * @Description     积分消费冲正_再次冲正
 * 
 * */

public class Integral_consume_correct_014_CorrectAgain_Test {
	/**
	 *积分消费参数列表
	 * 
	...
	@Test
	public void IntegralConsumeCorrect_CorrectAgain(String baseUrl)throws Exception {
		Random r = new Random();
...
///////再次进行积分消费冲正		
		// 传入消费冲正参数
		String resp3 = HttpRequestUtil.doPostJson(baseUrl + "paymentReserval", jsonStr2);
		//转换为字符串
