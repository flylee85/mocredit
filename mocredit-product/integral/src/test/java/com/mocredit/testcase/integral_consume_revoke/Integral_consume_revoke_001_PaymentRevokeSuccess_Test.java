 ...
 * 
 * @Description     积分消费撤销_积分消费撤销成功
 * 
 * */

public class Integral_consume_revoke_001_PaymentRevokeSuccess_Test {
	/**
	 * 积分消费参数列表
	 * 
	...
	@Test
	public void IntegralCounsemeRevoke_RevokeSuccess(String baseUrl,String paymentUrl) throws Exception{
    	Random r = new Random();
