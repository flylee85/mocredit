 ...
 * 
 * @Description     积分消费撤销_终端号参数为空
 * 
 * */

public class Integral_consume_revoke_002_EmptyDeviceNum_Test {
	...
	@Test
	public void IntegralConsumeRevoke_EmptyDeviceNum(String baseUrl)throws Exception {
		Random r = new Random();
