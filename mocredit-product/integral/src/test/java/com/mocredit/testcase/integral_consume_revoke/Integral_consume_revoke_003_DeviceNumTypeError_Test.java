 ...
 * 
 * @Description     积分消费撤销_终端号参数类型错误
 * 
 * */

public class Integral_consume_revoke_003_DeviceNumTypeError_Test {
	...
	@Test
	public void IntegralConsumeRevoke_DeviceNumTypeError(String baseUrl)throws Exception {
		Random r = new Random();
