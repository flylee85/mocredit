 ...
 * 
 * @Description     积分消费撤销_终端号参数长度过短
 * 
 * */

public class Integral_consume_revoke_004_ShorterDeviceNum_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsumeRevoke_ShorterDeviceNum(String baseUrl)throws Exception {
		Random r = new Random();
