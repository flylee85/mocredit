 ...
 * 
 * @Description     积分消费撤销_终端号参数长度过长
 * 
 * */

public class Integral_consume_revoke_005_LongerDeviceNum_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsumeRevoke_LongerDeviceNum(String baseUrl)throws Exception {
		Random r = new Random();
...
////////定义积分消费撤销缓冲区
		...
		Buffer.append("{");
		// 定义cardNum字段
		Buffer.append("\"bank\"").append(":").append("\"").append(device_longer).append("\"");
		// 定义integral字段
