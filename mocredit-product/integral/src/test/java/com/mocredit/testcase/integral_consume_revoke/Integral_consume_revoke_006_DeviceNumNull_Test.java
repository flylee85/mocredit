 ...
 * 
 * @Description     积分消费撤销_终端号参数为NULL
 * 
 * */

public class Integral_consume_revoke_006_DeviceNumNull_Test {
	...
	@Test
	public void IntegralConsumeRevoke_DeviceNumNull(String baseUrl)throws Exception {
		Random r = new Random();
