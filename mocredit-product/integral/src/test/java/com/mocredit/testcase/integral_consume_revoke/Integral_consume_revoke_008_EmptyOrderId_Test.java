 ...
 * 
 * @Description     积分消费撤销_订单号参数为空
 * 
 * */

public class Integral_consume_revoke_008_EmptyOrderId_Test {
	...
	@Test
	public void IntegralConsumeRevok_EmptyOrderId(String baseUrl)throws Exception {
		Random r = new Random();
