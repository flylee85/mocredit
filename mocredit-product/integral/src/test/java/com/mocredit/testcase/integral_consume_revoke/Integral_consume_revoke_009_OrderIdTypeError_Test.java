 ...
 * 
 * @Description     积分消费撤销_订单号参数类型错误
 * 
 * */

public class Integral_consume_revoke_009_OrderIdTypeError_Test {
	...
	@Test
	public void IntegralConsumeRevok_OrderIdTypeError(String baseUrl)throws Exception {
		Random r = new Random();
...
////////定义积分消费撤销缓冲区
		...
		// 定义integral字段
		Buffer.append("\"orderId\"").append(":").append("\"").append(orderId_type).append("\"");
		// 定义缓冲区结束
		Buffer.append("}");
		// 字符串转换成jsonStr
