 ...
 * 
 * @Description     积分消费撤销_订单号长度过短
 * 
 * */

public class Integral_consume_revoke_010_ShorterOrderId_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralConsumeRevok_ShorterOrderId(String baseUrl)throws Exception {
		Random r = new Random();
