 ...
 * 
 * @Description     积分消费撤销_订单号为null
 * 
 * */


public class Integral_consume_revoke_012_OrderIDNull_Test {
	...
	@Test
	public void IntegralConsumeRevok_OrderIDNull(String baseUrl)throws Exception {
		Random r = new Random();
