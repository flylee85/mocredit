 ...
 * 
 * @Description     积分消费撤销冲正_积分消费撤销冲正成功
 * 
 * */

public class Integral_consume_revoke_correct_001_RevokeCorrectSuccess_Test {
	/**
	 * 积分消费参数列表
	 * 
	...
	@Test
	public void IntegralCounsemeRevokeCorrect_RevokeCorrectSuccess(String baseUrl,String paymentUrl) throws Exception{
    	Random r = new Random();
