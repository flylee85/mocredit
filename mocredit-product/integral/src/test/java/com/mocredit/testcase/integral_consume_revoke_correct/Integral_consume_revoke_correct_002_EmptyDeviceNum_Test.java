 ...
 * 
 * @Description     积分消费撤销冲正_终端号参数为空
 * 
 * */

public class Integral_consume_revoke_correct_002_EmptyDeviceNum_Test {
	/**
	 * 积分消费参数列表
	 * 
	...
	@Test
	public void IntegralConsumeRevokeCorrect_EmptyDeviceNum(String baseUrl)throws Exception {
    	Random r = new Random();
		...
		String device_empty = PropertyUtil.getProInfo("parmeter", "device_empty");
...
////////定义积分消费撤销冲正缓冲区
		...
		Buffer3.append("{");
		// 定义cardNum字段
		Buffer3.append("\"device\"").append(":").append("\"").append(device_empty).append("\"");
		// 定义integral字段
