 ...
 * 
 * @Description     积分消费撤销冲正_终端号参数类型错误
 * 
 * */

public class Integral_consume_revoke_correct_003_DeviceNumTypeError_Test {
	/**
	 * 积分消费参数列表
	 * 
	...
	@Test
	public void IntegralConsumeRevokeCorrect_DeviceNumTypeError(String baseUrl)throws Exception {
		Random r = new Random();
		...
		String device_type = PropertyUtil.getProInfo("parmeter", "device_type");
...
////////定义积分消费撤销冲正缓冲区
		...
		Buffer3.append("{");
		// 定义cardNum字段
		Buffer3.append("\"device\"").append(":").append("\"").append(device_type).append("\"");
		// 定义integral字段
