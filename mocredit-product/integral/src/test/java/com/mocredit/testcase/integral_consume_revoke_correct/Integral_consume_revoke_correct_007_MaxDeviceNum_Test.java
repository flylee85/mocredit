 ...
 * 
 * @Description     积分消费撤销冲正_消费积分参数为最大长度30
 * 
 * */

public class Integral_consume_revoke_correct_007_MaxDeviceNum_Test {
	...
	@Test
	public void IntegralConsumeRevokCorrect_MaxDeviceNum(String baseUrl)throws Exception {
		Random r = new Random();
...
////////定义积分消费撤销冲正缓冲区
		...
		Buffer3.append("{");
		// 定义cardNum字段
		Buffer3.append("\"device\"").append(":").append("\"").append(device_max).append("\"");
		// 定义integral字段
