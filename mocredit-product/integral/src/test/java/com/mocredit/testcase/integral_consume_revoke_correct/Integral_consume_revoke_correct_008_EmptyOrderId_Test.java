 ...
 * 
 * @Description     积分消费撤销冲正_订单号参数为空
 * 
 * */

public class Integral_consume_revoke_correct_008_EmptyOrderId_Test {
	...
	@Test
	public void IntegralConsumeRevokCorrect_EmptyOrderId(String baseUrl)throws Exception {
		Random r = new Random();
...
////////定义积分消费撤销冲正缓冲区
		...
		// 定义integral字段
		Buffer3.append("\"orderId\"").append(":").append("\"").append(orderId_empty).append("\"");
		// 定义缓冲区结束
		Buffer3.append("}");
		// 字符串转换成jsonStr
