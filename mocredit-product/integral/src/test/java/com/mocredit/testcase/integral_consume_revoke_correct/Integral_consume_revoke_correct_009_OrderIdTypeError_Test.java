 ...
 * 
 * @Description     积分消费撤销冲正_订单号参数类型错误
 * 
 * */

public class Integral_consume_revoke_correct_009_OrderIdTypeError_Test {
	...
	@Test
	public void IntegralConsumeRevokCorrect_OrderIdTypeError(String baseUrl)throws Exception {
		Random r = new Random();
...
////////定义积分消费撤销冲正缓冲区
		...
		// 定义integral字段
		Buffer3.append("\"orderId\"").append(":").append("\"").append(orderId_type).append("\"");
		// 定义缓冲区结束
		Buffer3.append("}");
		// 字符串转换成jsonStr
