 ...
 * 
 * @Description     积分消费撤销冲正_订单号为null
 * 
 * */


public class Integral_consume_revoke_correct_012_OrderIDNull_Test {
	/**
	 * 积分消费参数列表
	 * 
	...
	@Test
	public void IntegralConsumeRevokCorrect_OrderIDNull(String baseUrl)throws Exception {
		Random r = new Random();
...
////////定义积分消费撤销冲正缓冲区
		...
		// 定义integral字段
		Buffer3.append("\"orderId\"").append(":").append("\"").append(orderId_null).append("\"");
		// 定义缓冲区结束
		Buffer3.append("}");
		// 字符串转换成jsonStr
