 ...
 * 
 * @Description     积分查询_银行参数为空
 * 
 * */

public class Integral_search_002_EmptyBankNum_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralSearch_EmptyBankNum(String baseUrl)throws Exception {
		String bank_empty = PropertyUtil.getProInfo("parmeter", "bank_empty");
...
////////定义积分查询缓冲区		
		...
		Buffer.append("{");
		// 定义bank字段
		Buffer.append("\"bank\"").append(":").append("\"").append(bank_empty).append("\"");
		// 定义device字段
