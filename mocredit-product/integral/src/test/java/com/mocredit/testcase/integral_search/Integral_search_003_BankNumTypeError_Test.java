 ...
 * 
 * @Description     积分查询_银行参数类型错误
 * 
 * */

public class Integral_search_003_BankNumTypeError_Test {
	...
	@Test
	public void IntegralSearch_BankNumTypeError(String baseUrl)throws Exception {
		String bank_type = PropertyUtil.getProInfo("parmeter", "bank_type");
...
////////定义积分查询缓冲区		
		...
		Buffer.append("{");
		// 定义bank字段
		Buffer.append("\"bank\"").append(":").append("\"").append(bank_type).append("\"");
		// 定义device字段
