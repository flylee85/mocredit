 ...
 * 
 * @Description     积分查询_银行参数过短
 * 
 * */

public class Integral_search_004_ShorterBankNum_Test {
	...
	@Test
	public void IntegralSearch_ShorterBankNum(String baseUrl)throws Exception {
		String bank_shorter = PropertyUtil.getProInfo("parmeter", "bank_shorter");
...
////////定义积分查询缓冲区		
		...
		Buffer.append("{");
		// 定义bank字段
		Buffer.append("\"bank\"").append(":").append("\"").append(bank_shorter).append("\"");
		// 定义device字段
