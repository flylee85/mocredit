 ...
 * 
 * @Description     积分查询_银行参数过长
 * 
 * */

public class Integral_search_005_LongerBankNum_Test {
	...
	@Test
	public void IntegralSearch_LongerBankNum(String baseUrl)throws Exception {
		String bank_longer = PropertyUtil.getProInfo("parmeter", "bank_longer");
...
////////定义积分查询缓冲区		
		...
		Buffer.append("{");
		// 定义bank字段
		Buffer.append("\"bank\"").append(":").append("\"").append(bank_longer).append("\"");
		// 定义device字段
