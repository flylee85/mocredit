 ...
 * 
 * @Description     积分查询_银行参数为最大长度30
 * 
 * */

public class Integral_search_007_MaxBankNum_Test {
	...
	@Test
	public void IntegralSearch_MaxBankNum(String baseUrl)throws Exception {
		String bank_max = PropertyUtil.getProInfo("parmeter", "bank_max");
...
////////定义积分查询缓冲区		
		...
		Buffer.append("{");
		// 定义bank字段
		Buffer.append("\"bank\"").append(":").append("\"").append(bank_max).append("\"");
		// 定义device字段
