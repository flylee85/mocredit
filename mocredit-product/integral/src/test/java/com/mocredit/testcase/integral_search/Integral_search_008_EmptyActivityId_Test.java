 ...
 * 
 * @Description     积分查询_活动ID参数为空
 * 
 * */

public class Integral_search_008_EmptyActivityId_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralSearch_EmptyActivityId(String baseUrl)throws Exception {
...
////////定义积分查询缓冲区		
		...
		// 定义device字段
		Buffer.append("\"device\"").append(":").append("\"").append(activityId_empty).append("\"");
		// 定义orderId字段
