 ...
 * 
 * @Description     积分查询_活动ID参数类型错误
 * 
 * */

public class Integral_search_009_ActivityIdTypeError_Test {
	...
	@Test
	public void IntegralSearch_ActivityIdTypeError(String baseUrl)throws Exception {
...
////////定义积分查询缓冲区		
		...
		// 定义device字段
		Buffer.append("\"device\"").append(":").append("\"").append(activityId_type).append("\"");
		// 定义orderId字段
