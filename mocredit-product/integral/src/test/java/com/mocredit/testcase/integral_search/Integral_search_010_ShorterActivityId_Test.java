 ...
 * 
 * @Description     积分查询_活动ID参数过短
 * 
 * */

public class Integral_search_010_ShorterActivityId_Test {
	...
	@Test
	public void IntegralSearch_ShorterActivityId(String baseUrl)throws Exception {
...
////////定义积分查询缓冲区		
		...
		// 定义device字段
		Buffer.append("\"device\"").append(":").append("\"").append(activityId_shorter).append("\"");
		// 定义orderId字段
