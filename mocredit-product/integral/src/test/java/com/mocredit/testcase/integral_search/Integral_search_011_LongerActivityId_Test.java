 ...
 * 
 * @Description     积分查询_活动ID参数过长
 * 
 * */

public class Integral_search_011_LongerActivityId_Test {
	...
	@Test
	public void IntegralSearch_LongerActivityId(String baseUrl)throws Exception {
...
////////定义积分查询缓冲区		
		...
		// 定义device字段
		Buffer.append("\"device\"").append(":").append("\"").append(activityId_longer).append("\"");
		// 定义orderId字段
