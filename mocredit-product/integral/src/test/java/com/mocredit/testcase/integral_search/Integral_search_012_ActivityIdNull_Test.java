 ...
 * 
 * @Description     积分查询_活动ID参数为NULL
 * 
 * */

public class Integral_search_012_ActivityIdNull_Test {
	...
	@Test
	public void IntegralSearch_ActivityIdNull(String baseUrl)throws Exception {
...
////////定义积分查询缓冲区		
		...
		// 定义device字段
		Buffer.append("\"device\"").append(":").append("\"").append(activityId_null).append("\"");
		// 定义orderId字段
