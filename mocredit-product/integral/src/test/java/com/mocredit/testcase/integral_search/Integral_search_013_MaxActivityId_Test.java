 ...
 * 
 * @Description     积分查询_活动ID参数为最大长度30
 * 
 * */

public class Integral_search_013_MaxActivityId_Test {
	...
	@Test
	public void IntegralSearch_MaxActivityId(String baseUrl)throws Exception {
...
////////定义积分查询缓冲区		
		...
		// 定义device字段
		Buffer.append("\"device\"").append(":").append("\"").append(activityId_max).append("\"");
		// 定义orderId字段
