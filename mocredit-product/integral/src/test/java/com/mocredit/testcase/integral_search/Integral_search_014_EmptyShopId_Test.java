 ...
 * 
 * @Description     积分查询_商户ID参数为空
 * 
 * */

public class Integral_search_014_EmptyShopId_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralSearch_EmptyShopId(String baseUrl)throws Exception {
...
////////定义积分查询缓冲区		
		...
		// 定义activityId字段
		Buffer.append("\"activityId\"").append(":").append("\"").append(shopId_empty).append("\"");
		// 定义缓冲区结束
		Buffer.append("}");
		// 字符串转换成jsonStr
