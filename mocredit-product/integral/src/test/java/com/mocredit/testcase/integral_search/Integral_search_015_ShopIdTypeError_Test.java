 ...
 * 
 * @Description     积分查询_商户ID参数类型错误
 * 
 * */

public class Integral_search_015_ShopIdTypeError_Test {
	...
	@Test
	public void IntegralSearch_ShopIdTypeError(String baseUrl)throws Exception {
...
////////定义积分查询缓冲区		
		...
		// 定义activityId字段
		Buffer.append("\"activityId\"").append(":").append("\"").append(shopId_type).append("\"");
		// 定义缓冲区结束
		Buffer.append("}");
		// 字符串转换成jsonStr
