 ...
 * 
 * @Description     积分查询_商户ID参数为NULL
 * 
 * */

public class Integral_search_018_ShopIdNull_Test {
	...
	@Test
	public void IntegralSearch_ShopIdNull(String baseUrl)throws Exception {
...
////////定义积分查询缓冲区		
		...
		// 定义activityId字段
		Buffer.append("\"activityId\"").append(":").append("\"").append(shopId_null).append("\"");
		// 定义缓冲区结束
		Buffer.append("}");
		// 字符串转换成jsonStr
