 ...
 * 
 * @Description     积分查询_银行卡号参数为空
 * 
 * */

public class Integral_search_020_EmptyCardNum_Test {
	...
	@Parameters({ "baseUrl"})
	@Test
	public void IntegralSearch_EmptyCardNum(String baseUrl)throws Exception {
		String bank = PropertyUtil.getProInfo("parmeter", "bank_citic");
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String cardNum_empty = PropertyUtil.getProInfo("parmeter", "cardNum_empty");
...
////////定义积分查询缓冲区		
		...
		// 定义orderId字段
		Buffer.append("\"orderId\"").append(":").append("\"").append(cardNum_empty).append("\"");
		// 定义activityId字段
