 ...
 * 
 * @Description     积分查询_银行卡号参数类型错误
 * 
 * */

public class Integral_search_021_CardNumTypeError_Test {
	...
	@Test
	public void IntegralSearch_CardNumTypeError(String baseUrl)throws Exception {
		String bank = PropertyUtil.getProInfo("parmeter", "bank_citic");
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String cardNum_type = PropertyUtil.getProInfo("parmeter", "cardNum_type");
...
////////定义积分查询缓冲区		
		...
		// 定义orderId字段
		Buffer.append("\"orderId\"").append(":").append("\"").append(cardNum_type).append("\"");
		// 定义activityId字段
