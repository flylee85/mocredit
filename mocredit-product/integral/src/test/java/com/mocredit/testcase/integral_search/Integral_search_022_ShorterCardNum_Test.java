 ...
 * 
 * @Description     积分查询_银行卡号参数过短
 * 
 * */

public class Integral_search_022_ShorterCardNum_Test {
	...
	@Test
	public void IntegralSearch_ShorterCardNum(String baseUrl)throws Exception {
		String bank = PropertyUtil.getProInfo("parmeter", "bank_citic");
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String cardNum_shorter = PropertyUtil.getProInfo("parmeter", "cardNum_shorter");
...
////////定义积分查询缓冲区		
		...
		// 定义orderId字段
		Buffer.append("\"orderId\"").append(":").append("\"").append(cardNum_shorter).append("\"");
		// 定义activityId字段
