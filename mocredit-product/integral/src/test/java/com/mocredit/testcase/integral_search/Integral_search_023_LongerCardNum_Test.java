 ...
 * 
 * @Description     积分查询_银行卡号参数过长
 * 
 * */

public class Integral_search_023_LongerCardNum_Test {
	...
	@Test
	public void IntegralSearch_LongerCardNum(String baseUrl)throws Exception {
		String bank = PropertyUtil.getProInfo("parmeter", "bank_citic");
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String cardNum_longer = PropertyUtil.getProInfo("parmeter", "cardNum_longer");
...
////////定义积分查询缓冲区		
		...
		// 定义orderId字段
		Buffer.append("\"orderId\"").append(":").append("\"").append(cardNum_longer).append("\"");
		// 定义activityId字段
