 ...
 * 
 * @Description     积分查询_银行卡号参数为NULL
 * 
 * */

public class Integral_search_024_CardNumNull_Test {
	...
	@Test
	public void IntegralSearch_CardNumNull(String baseUrl)throws Exception {
		String bank = PropertyUtil.getProInfo("parmeter", "bank_citic");
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String cardNum_null = PropertyUtil.getProInfo("parmeter", "cardNum_null");
...
////////定义积分查询缓冲区		
		...
		// 定义orderId字段
		Buffer.append("\"orderId\"").append(":").append("\"").append(cardNum_null).append("\"");
		// 定义activityId字段
