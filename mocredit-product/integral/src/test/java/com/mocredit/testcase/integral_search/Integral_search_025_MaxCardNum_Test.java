 ...
 * 
 * @Description     积分查询_银行卡号参数为最大长度30
 * 
 * */

public class Integral_search_025_MaxCardNum_Test {
	...
	@Test
	public void IntegralSearch_MaxCardNum(String baseUrl)throws Exception {
		String bank = PropertyUtil.getProInfo("parmeter", "bank_citic");
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String cardNum_max = PropertyUtil.getProInfo("parmeter", "cardNum_max");
...
////////定义积分查询缓冲区		
		...
		// 定义orderId字段
		Buffer.append("\"orderId\"").append(":").append("\"").append(cardNum_max).append("\"");
		// 定义activityId字段
