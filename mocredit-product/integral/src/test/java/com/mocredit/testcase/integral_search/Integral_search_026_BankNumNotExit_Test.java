...
public class Integral_search_026_BankNumNotExit_Test {
	...
	@Test
	public void IntegralSearch_BankNumNotExit(String baseUrl)throws Exception {
		String bank_errornum = PropertyUtil.getProInfo("parmeter", "bank_errornum");
...
////////定义积分查询缓冲区		
		...
		Buffer.append("{");
		// 定义bank字段
		Buffer.append("\"bank\"").append(":").append("\"").append(bank_errornum).append("\"");
		// 定义device字段
