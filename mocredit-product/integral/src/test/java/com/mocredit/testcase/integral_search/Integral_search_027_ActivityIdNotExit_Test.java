 ...
 * 
 * @Description     积分查询_活动Id不存在
 * 
 * */

public class Integral_search_027_ActivityIdNotExit_Test {
	...
	@Test
	public void IntegralSearch_ActivityIdNotExit(String baseUrl)throws Exception {
		String bank = PropertyUtil.getProInfo("parmeter", "bank");
		String activityId_noexist = PropertyUtil.getProInfo("parmeter", "activityId_noexist");
...
////////定义积分查询缓冲区		
		...
		// 定义device字段
		Buffer.append("\"device\"").append(":").append("\"").append(activityId_noexist).append("\"");
		// 定义orderId字段
