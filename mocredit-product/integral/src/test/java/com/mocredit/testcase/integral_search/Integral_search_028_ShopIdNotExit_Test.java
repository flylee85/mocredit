 ...
 * 
 * @Description     积分查询_商户Id不存在
 * 
 * */

public class Integral_search_028_ShopIdNotExit_Test {
	...
	public void IntegralSearch_ShopIdNotExit(String baseUrl)throws Exception {
		...
		String shopId_notexit = PropertyUtil.getProInfo("parmeter", "shopId_notexit");
...
////////定义积分查询缓冲区		
		...
		// 定义activityId字段
		Buffer.append("\"activityId\"").append(":").append("\"").append(shopId_notexit).append("\"");
		// 定义缓冲区结束
		Buffer.append("}");
		// 字符串转换成jsonStr
