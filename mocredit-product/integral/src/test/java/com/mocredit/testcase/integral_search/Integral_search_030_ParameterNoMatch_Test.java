 ...
 * 
 * @Description     积分查询_入参不匹配
 * 
 * */

public class Integral_search_030_ParameterNoMatch_Test {
	...
	@Test
	public void IntegralSearch_ParameterNoMatch(String baseUrl)throws Exception {
		String bank = PropertyUtil.getProInfo("parmeter", "bank");
		String activityId = PropertyUtil.getProInfo("parmeter", "activityId");
		String cardNum_notexist = PropertyUtil.getProInfo("parmeter", "cardNum_notexist");
...
////////定义积分查询缓冲区		
		...
		// 定义orderId字段
		Buffer.append("\"orderId\"").append(":").append("\"").append(cardNum_notexist).append("\"");
		// 定义activityId字段
