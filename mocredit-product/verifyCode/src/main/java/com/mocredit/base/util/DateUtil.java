...
public class DateUtil {
	 ...
	 * @return
	 */
	public static String  getWeekDayForToday(){
		int d=Calendar.getInstance().get(Calendar.DAY_OF_WEEK);
//		Calendar cal=Calendar.getInstance();
//		cal.setTime( DateUtil.strToDate("2015-7-24 ","yyyy-MM-dd"));
//		int d= cal.get(Calendar.DAY_OF_WEEK);
		if( d- BaseCalendar.SUNDAY >0 ){
			return  String.valueOf( d - BaseCalendar.SUNDAY );
		}else {
