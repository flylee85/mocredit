...
/**
 * 提供已验证码的表的操作 Created by YHL on 15/7/9 09:47.
 *
 * @version 1.0
 * @Auth YangHL
...
public interface VerifiedCodeMapper {
	 ...
	 * @return
	 */
	public List<TVerifiedCode> findVerifiedCodesByCodeAndRequestSerialNumber(@Param("code") String code,
			@Param("request_serial_number") String requestSeriaNumber);
	 ...
	 * @return
	 */
	public TVerifiedCode findByDeviceAndRequestSerialNumber(@Param("device") String device,
			@Param("request_serial_number") String requestSeriaNumber);
