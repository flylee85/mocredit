...
import com.mocredit.security.dao.AuthorizationDao;
...
public class AuthorizationServiceImpl implements AuthorizationService {
    ...
    public Set<String> findPermissions(String username) {
        ...
        List<Long> roleIdList = roleService.findRoleIdByUserId(user.getId());
        return roleService.findPermissions(roleIdList.toArray(new Long[roleIdList.size()]));
    }

    public void updateAuthorizationRoleByUserId(Long userId, Long roleId) {
     authorizationDao.updateAuthorizationRoleByUserId(userId,roleId);
    }
}
